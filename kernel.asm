...
801001ae:	e8 4d 47 00 00       	call   80104900 <holdingsleep>
...
801001ef:	e8 0c 47 00 00       	call   80104900 <holdingsleep>
...
801001ff:	e8 bc 46 00 00       	call   801048c0 <releasesleep>

  acquire(&bcache.lock);
80100204:	c7 04 24 c0 c5 10 80 	movl   $0x8010c5c0,(%esp)
8010020b:	e8 80 48 00 00       	call   80104a90 <acquire>
  b->refcnt--;
...
8010025b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010025c:	e9 ef 48 00 00       	jmp    80104b50 <release>
    panic("brelse");
...
8010028c:	e8 ff 47 00 00       	call   80104a90 <acquire>
  while(n > 0){
...
801002c5:	e8 16 3d 00 00       	call   80103fe0 <sleep>
    while(input.r == input.w){
...
801002ef:	e8 5c 48 00 00       	call   80104b50 <release>
        ilock(ip);
...
8010034d:	e8 fe 47 00 00       	call   80104b50 <release>
  ilock(ip);
...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 e0 7c 10 80 	movl   $0x80107ce0,(%esp)
...
801003d8:	e8 93 45 00 00       	call   80104970 <getcallerpcs>
...
80100524:	e8 27 47 00 00       	call   80104c50 <memmove>
...
80100541:	e8 5a 46 00 00       	call   80104ba0 <memset>
...
8010061b:	e8 70 44 00 00       	call   80104a90 <acquire>
  for(i = 0; i < n; i++)
...
80100647:	e8 04 45 00 00       	call   80104b50 <release>
  ilock(ip);
8010064c:	58                   	pop    %eax
...
8010071f:	e8 2c 44 00 00       	call   80104b50 <release>
...
801007f0:	e8 9b 42 00 00       	call   80104a90 <acquire>
...
80100823:	e8 68 42 00 00       	call   80104a90 <acquire>
  while((c = getc()) >= 0){
...
80100888:	e8 c3 42 00 00       	call   80104b50 <release>
  if(doprocdump) {
...
801009d0:	e8 7b 3f 00 00       	call   80104950 <initlock>
...
80100c39:	e8 82 41 00 00       	call   80104dc0 <strlen>
...
80100c4c:	e8 6f 41 00 00       	call   80104dc0 <strlen>
...
80100d08:	e8 73 40 00 00       	call   80104d80 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d63:	e8 b8 62 00 00       	call   80107020 <switchuvm>
  freevm(oldpgdir);
80100d68:	89 3c 24             	mov    %edi,(%esp)
80100d6b:	e8 60 66 00 00       	call   801073d0 <freevm>
  return 0;
...
80100d96:	68 8d 77 10 80       	push   $0x8010778d
80100d9b:	68 c0 0f 11 80       	push   $0x80110fc0
80100da0:	e8 ab 3b 00 00       	call   80104950 <initlock>
}
...
80100dc1:	e8 ca 3c 00 00       	call   80104a90 <acquire>
...
80100df1:	e8 5a 3d 00 00       	call   80104b50 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e0a:	e8 41 3d 00 00       	call   80104b50 <release>
}
...
80100e2f:	e8 5c 3c 00 00       	call   80104a90 <acquire>
  if(f->ref < 1)
...
80100e4c:	e8 ff 3c 00 00       	call   80104b50 <release>
  return f;
}
...
80100e5b:	68 94 77 10 80       	push   $0x80107794
...
80100e81:	e8 0a 3c 00 00       	call   80104a90 <acquire>
  if(f->ref < 1)
...
80100eab:	5d                   	pop    %ebp
    release(&ftable.lock);
80100eac:	e9 9f 3c 00 00       	jmp    80104b50 <release>
...
80100ed5:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100ed8:	e8 73 3c 00 00       	call   80104b50 <release>
  if(ff.type == FD_PIPE)
...
80100f32:	68 9c 77 10 80       	push   $0x8010779c
...
80101012:	68 a6 77 10 80       	push   $0x801077a6
...
80101125:	68 af 77 10 80       	push   $0x801077af
8010112a:	e8 61 f2 ff ff       	call   80100390 <panic>
  panic("filewrite");
8010112f:	83 ec 0c             	sub    $0xc,%esp
80101132:	68 b5 77 10 80       	push   $0x801077b5
...
801011a3:	68 bf 77 10 80       	push   $0x801077bf
...
80101254:	68 d2 77 10 80       	push   $0x801077d2
...
80101295:	e8 06 39 00 00       	call   80104ba0 <memset>
  log_write(bp);
...
801012da:	e8 b1 37 00 00       	call   80104a90 <acquire>
...
8010133f:	e8 0c 38 00 00       	call   80104b50 <release>
...
8010136a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010136d:	e8 de 37 00 00       	call   80104b50 <release>
      return ip;
...
80101382:	68 e8 77 10 80       	push   $0x801077e8
...
80101457:	68 f8 77 10 80       	push   $0x801077f8
...
80101491:	e8 ba 37 00 00       	call   80104c50 <memmove>
  brelse(bp);
...
80101529:	68 78 78 10 80       	push   $0x80107878
...
801015be:	e8 dd 35 00 00       	call   80104ba0 <memset>
      dip->type = type;
...
80101661:	e8 ea 35 00 00       	call   80104c50 <memmove>
  log_write(bp);
...
8010168f:	e8 fc 33 00 00       	call   80104a90 <acquire>
  ip->ref++;
80101694:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101698:	c7 04 24 e0 19 11 80 	movl   $0x801119e0,(%esp)
8010169f:	e8 ac 34 00 00       	call   80104b50 <release>
}
...
801016d2:	e8 89 31 00 00       	call   80104860 <acquiresleep>
  if(ip->valid == 0){
...
80101748:	e8 03 35 00 00       	call   80104c50 <memmove>
    brelse(bp);
...
8010176d:	68 30 78 10 80       	push   $0x80107830
80101772:	e8 19 ec ff ff       	call   80100390 <panic>
    panic("ilock");
80101777:	83 ec 0c             	sub    $0xc,%esp
8010177a:	68 2a 78 10 80       	push   $0x8010782a
...
801017a3:	e8 58 31 00 00       	call   80104900 <holdingsleep>
...
801017be:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801017bf:	e9 fc 30 00 00       	jmp    801048c0 <releasesleep>
    panic("iunlock");
801017c4:	83 ec 0c             	sub    $0xc,%esp
801017c7:	68 3f 78 10 80       	push   $0x8010783f
...
801017f0:	e8 6b 30 00 00       	call   80104860 <acquiresleep>
...
8010180a:	e8 b1 30 00 00       	call   801048c0 <releasesleep>
  acquire(&icache.lock);
8010180f:	c7 04 24 e0 19 11 80 	movl   $0x801119e0,(%esp)
80101816:	e8 75 32 00 00       	call   80104a90 <acquire>
  ip->ref--;
...
80101a35:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a37:	e8 14 32 00 00       	call   80104c50 <memmove>
    brelse(bp);
...
80101b33:	e8 18 31 00 00       	call   80104c50 <memmove>
    log_write(bp);
...
80101bce:	e8 ed 30 00 00       	call   80104cc0 <strncmp>
}
80101bd3:	c9                   	leave  
80101bd4:	c3                   	ret    
...
80101c2d:	e8 8e 30 00 00       	call   80104cc0 <strncmp>
      continue;
...
80101c72:	68 59 78 10 80       	push   $0x80107859
80101c77:	e8 14 e7 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101c7c:	83 ec 0c             	sub    $0xc,%esp
80101c7f:	68 47 78 10 80       	push   $0x80107847
...
80101cb9:	e8 d2 2d 00 00       	call   80104a90 <acquire>
  ip->ref++;
80101cbe:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101cc2:	c7 04 24 e0 19 11 80 	movl   $0x801119e0,(%esp)
80101cc9:	e8 82 2e 00 00       	call   80104b50 <release>
...
80101d25:	e8 26 2f 00 00       	call   80104c50 <memmove>
    path++;
...
80101db8:	e8 93 2e 00 00       	call   80104c50 <memmove>
    name[len] = 0;
...
80101ead:	e8 6e 2e 00 00       	call   80104d20 <strncpy>
  de.inum = inum;
...
80101eeb:	68 68 78 10 80       	push   $0x80107868
80101ef0:	e8 9b e4 ff ff       	call   80100390 <panic>
    panic("dirlink");
80101ef5:	83 ec 0c             	sub    $0xc,%esp
80101ef8:	68 2a 7f 10 80       	push   $0x80107f2a
...
8010200b:	68 d4 78 10 80       	push   $0x801078d4
80102010:	e8 7b e3 ff ff       	call   80100390 <panic>
    panic("idestart");
80102015:	83 ec 0c             	sub    $0xc,%esp
80102018:	68 cb 78 10 80       	push   $0x801078cb
...
80102036:	68 e6 78 10 80       	push   $0x801078e6
8010203b:	68 80 b5 10 80       	push   $0x8010b580
80102040:	e8 0b 29 00 00       	call   80104950 <initlock>
...
801020be:	e8 cd 29 00 00       	call   80104a90 <acquire>
...
80102121:	e8 5a 21 00 00       	call   80104280 <wakeup>
...
8010213f:	e8 0c 2a 00 00       	call   80104b50 <release>
...
8010215e:	e8 9d 27 00 00       	call   80104900 <holdingsleep>
...
80102198:	e8 f3 28 00 00       	call   80104a90 <acquire>
...
801021e9:	e8 f2 1d 00 00       	call   80103fe0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102205:	c9                   	leave  
  release(&idelock);
80102206:	e9 45 29 00 00       	jmp    80104b50 <release>
8010220b:	90                   	nop
...
801022a7:	68 34 79 10 80       	push   $0x80107934
...
80102382:	e8 19 28 00 00       	call   80104ba0 <memset>
...
8010243b:	68 6c 79 10 80       	push   $0x8010796c
80102440:	68 40 36 11 80       	push   $0x80113640
80102445:	e8 06 25 00 00       	call   80104950 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102533:	e8 58 25 00 00       	call   80104a90 <acquire>
  r = kmem.freelist;
...
80102561:	e8 ea 25 00 00       	call   80104b50 <release>
  return (char*)r;
...
801025b3:	0f b6 82 a0 7a 10 80 	movzbl -0x7fef8560(%edx),%eax
801025ba:	09 c1                	or     %eax,%ecx
  shift ^= togglecode[data];
801025bc:	0f b6 82 a0 79 10 80 	movzbl -0x7fef8660(%edx),%eax
...
801025d0:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
801025d3:	8b 04 85 80 79 10 80 	mov    -0x7fef8680(,%eax,4),%eax
...
801025f5:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801025f8:	0f b6 82 a0 7a 10 80 	movzbl -0x7fef8560(%edx),%eax
...
80102977:	e8 74 22 00 00       	call   80104bf0 <memcmp>
...
80102aa4:	e8 a7 21 00 00       	call   80104c50 <memmove>
...
80102b4a:	68 a0 7b 10 80       	push   $0x80107ba0
80102b4f:	68 80 36 11 80       	push   $0x80113680
80102b54:	e8 f7 1d 00 00       	call   80104950 <initlock>
  readsb(dev, &sb);
80102b59:	58                   	pop    %eax
...
80102beb:	e8 a0 1e 00 00       	call   80104a90 <acquire>
...
80102c05:	e8 d6 13 00 00       	call   80103fe0 <sleep>
...
80102c3c:	e8 0f 1f 00 00       	call   80104b50 <release>
      break;
    }
  }
}
...
80102c5e:	e8 2d 1e 00 00       	call   80104a90 <acquire>
  log.outstanding -= 1;
...
80102c9c:	e8 af 1e 00 00       	call   80104b50 <release>
}
...
80102cf6:	e8 55 1f 00 00       	call   80104c50 <memmove>
...
80102d3f:	e8 4c 1d 00 00       	call   80104a90 <acquire>
    wakeup(&log);
...
80102d52:	00 00 00 
    wakeup(&log);
80102d55:	e8 26 15 00 00       	call   80104280 <wakeup>
    release(&log.lock);
80102d5a:	c7 04 24 80 36 11 80 	movl   $0x80113680,(%esp)
80102d61:	e8 ea 1d 00 00       	call   80104b50 <release>
...
80102d80:	e8 fb 14 00 00       	call   80104280 <wakeup>
  release(&log.lock);
80102d85:	c7 04 24 80 36 11 80 	movl   $0x80113680,(%esp)
80102d8c:	e8 bf 1d 00 00       	call   80104b50 <release>
...
80102d9f:	68 a4 7b 10 80       	push   $0x80107ba4
...
80102dee:	e8 9d 1c 00 00       	call   80104a90 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e3c:	c9                   	leave  
  release(&log.lock);
80102e3d:	e9 0e 1d 00 00       	jmp    80104b50 <release>
...
80102e69:	68 b3 7b 10 80       	push   $0x80107bb3
80102e6e:	e8 1d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e73:	83 ec 0c             	sub    $0xc,%esp
80102e76:	68 c9 7b 10 80       	push   $0x80107bc9
...
80102e98:	68 e4 7b 10 80       	push   $0x80107be4
80102e9d:	e8 be d7 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102ea2:	e8 69 30 00 00       	call   80105f10 <idtinit>
...
80102ec3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102ec6:	e8 35 41 00 00       	call   80107000 <switchkvm>
  seginit();
80102ecb:	e8 a0 40 00 00       	call   80106f70 <seginit>
  lapicinit();
...
80102f24:	e8 17 33 00 00       	call   80106240 <uartinit>
  pinit();         // process table
80102f29:	e8 02 08 00 00       	call   80103730 <pinit>
  tvinit();        // trap vectors
80102f2e:	e8 5d 2f 00 00       	call   80105e90 <tvinit>
  binit();         // buffer cache
...
80102f54:	e8 f7 1c 00 00       	call   80104c50 <memmove>
...
8010302e:	68 f8 7b 10 80       	push   $0x80107bf8
80103033:	56                   	push   %esi
80103034:	e8 b7 1b 00 00       	call   80104bf0 <memcmp>
...
801030ec:	68 15 7c 10 80       	push   $0x80107c15
801030f1:	56                   	push   %esi
801030f2:	e8 f9 1a 00 00       	call   80104bf0 <memcmp>
...
80103180:	ff 24 95 3c 7c 10 80 	jmp    *-0x7fef83c4(,%edx,4)
...
80103233:	68 fd 7b 10 80       	push   $0x80107bfd
80103238:	e8 53 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010323d:	83 ec 0c             	sub    $0xc,%esp
80103240:	68 1c 7c 10 80       	push   $0x80107c1c
...
80103338:	00 00 00 
  initlock(&p->lock, "pipe");
8010333b:	68 50 7c 10 80       	push   $0x80107c50
80103340:	50                   	push   %eax
80103341:	e8 0a 16 00 00       	call   80104950 <initlock>
  (*f0)->type = FD_PIPE;
...
8010339f:	e8 ec 16 00 00       	call   80104a90 <acquire>
  if(writable){
...
801033bf:	e8 bc 0e 00 00       	call   80104280 <wakeup>
...
801033e3:	5d                   	pop    %ebp
    release(&p->lock);
801033e4:	e9 67 17 00 00       	jmp    80104b50 <release>
...
80103404:	e8 77 0e 00 00       	call   80104280 <wakeup>
...
80103414:	e8 37 17 00 00       	call   80104b50 <release>
    kfree((char*)p);
...
8010343d:	e8 4e 16 00 00       	call   80104a90 <acquire>
  for(i = 0; i < n; i++){
...
80103494:	e8 e7 0d 00 00       	call   80104280 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103499:	5a                   	pop    %edx
8010349a:	59                   	pop    %ecx
8010349b:	53                   	push   %ebx
8010349c:	56                   	push   %esi
8010349d:	e8 3e 0b 00 00       	call   80103fe0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801034d4:	e8 77 16 00 00       	call   80104b50 <release>
        return -1;
...
80103523:	e8 58 0d 00 00       	call   80104280 <wakeup>
  release(&p->lock);
80103528:	89 1c 24             	mov    %ebx,(%esp)
8010352b:	e8 20 16 00 00       	call   80104b50 <release>
  return n;
...
80103550:	e8 3b 15 00 00       	call   80104a90 <acquire>
...
80103585:	e8 56 0a 00 00       	call   80103fe0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
801035be:	e8 8d 15 00 00       	call   80104b50 <release>
      return -1;
...
8010361f:	e8 2c 15 00 00       	call   80104b50 <release>
  return i;
...
80103646:	b9 03 00 00 00       	mov    $0x3,%ecx
...
80103652:	be 54 3d 11 80       	mov    $0x80113d54,%esi
{
80103657:	83 ec 2c             	sub    $0x2c,%esp
8010365a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(p->state == -SLEEPING);
80103660:	8b 46 0c             	mov    0xc(%esi),%eax
80103663:	83 f8 fe             	cmp    $0xfffffffe,%eax
80103666:	74 f8                	je     80103660 <wakeup1+0x20>
    if((p->state == SLEEPING) && p->chan == chan){
80103668:	8b 46 0c             	mov    0xc(%esi),%eax
8010366b:	83 f8 02             	cmp    $0x2,%eax
8010366e:	74 20                	je     80103690 <wakeup1+0x50>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103670:	81 c6 90 01 00 00    	add    $0x190,%esi
80103676:	81 fe 54 a1 11 80    	cmp    $0x8011a154,%esi
...
80103689:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if((p->state == SLEEPING) && p->chan == chan){
80103690:	39 7e 20             	cmp    %edi,0x20(%esi)
80103693:	75 db                	jne    80103670 <wakeup1+0x30>
80103695:	8d 5e 0c             	lea    0xc(%esi),%ebx
...
801036a4:	74 ca                	je     80103670 <wakeup1+0x30>
        p->chan = 0;
801036a6:	c7 46 20 00 00 00 00 	movl   $0x0,0x20(%esi)
801036ad:	89 d0                	mov    %edx,%eax
801036af:	f0 0f b1 0b          	lock cmpxchg %ecx,(%ebx)
801036b3:	9c                   	pushf  
801036b4:	8f 45 e4             	popl   -0x1c(%ebp)
        if(!cas(&p->state,-RUNNABLE,RUNNABLE)){
801036b7:	f6 45 e4 40          	testb  $0x40,-0x1c(%ebp)
801036bb:	75 b3                	jne    80103670 <wakeup1+0x30>
          cprintf("wakeup1 cas err\n");
801036bd:	83 ec 0c             	sub    $0xc,%esp
801036c0:	89 4d d0             	mov    %ecx,-0x30(%ebp)
801036c3:	89 55 d4             	mov    %edx,-0x2c(%ebp)
801036c6:	68 55 7c 10 80       	push   $0x80107c55
801036cb:	e8 90 cf ff ff       	call   80100660 <cprintf>
801036d0:	83 c4 10             	add    $0x10,%esp
801036d3:	8b 4d d0             	mov    -0x30(%ebp),%ecx
801036d6:	8b 55 d4             	mov    -0x2c(%ebp),%edx
801036d9:	eb 95                	jmp    80103670 <wakeup1+0x30>
801036db:	90                   	nop
...
801036e3:	83 ec 08             	sub    $0x8,%esp
  popcli();
801036e6:	e8 15 13 00 00       	call   80104a00 <popcli>
  if (first) {
...
80103736:	68 66 7c 10 80       	push   $0x80107c66
8010373b:	68 20 3d 11 80       	push   $0x80113d20
80103740:	e8 0b 12 00 00       	call   80104950 <initlock>
}
...
801037f4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037f7:	e8 c4 11 00 00       	call   801049c0 <pushcli>
  c = mycpu();
801037fc:	e8 4f ff ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103801:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103807:	e8 f4 11 00 00       	call   80104a00 <popcli>
}
...
8010382a:	83 ec 10             	sub    $0x10,%esp
  pushcli();
8010382d:	e8 8e 11 00 00       	call   801049c0 <pushcli>
...
8010384c:	74 ea                	je     80103838 <allocpid+0x18>
  popcli();
8010384e:	e8 ad 11 00 00       	call   80104a00 <popcli>
}
...
8010386a:	83 ec 10             	sub    $0x10,%esp
  pushcli();
8010386d:	e8 4e 11 00 00       	call   801049c0 <pushcli>
...
801038a1:	74 dd                	je     80103880 <allocproc+0x20>
  popcli();
801038a3:	e8 58 11 00 00       	call   80104a00 <popcli>
  p->pid = allocpid();
...
801038ba:	0f 84 98 00 00 00    	je     80103958 <allocproc+0xf8>
  sp -= sizeof *p->tf;
...
801038d1:	c7 40 14 77 5e 10 80 	movl   $0x80105e77,0x14(%eax)
...
801038e0:	e8 bb 12 00 00       	call   80104ba0 <memset>
...
80103933:	c3                   	ret    
    popcli();
80103934:	e8 c7 10 00 00       	call   80104a00 <popcli>
    cprintf("failed %d\n",p->state);
80103939:	8b 46 0c             	mov    0xc(%esi),%eax
8010393c:	83 ec 08             	sub    $0x8,%esp
    return 0;
8010393f:	31 f6                	xor    %esi,%esi
    cprintf("failed %d\n",p->state);
80103941:	50                   	push   %eax
80103942:	68 7d 7c 10 80       	push   $0x80107c7d
80103947:	e8 14 cd ff ff       	call   80100660 <cprintf>
    return 0;
...
80103958:	83 ec 0c             	sub    $0xc,%esp
    p->state = UNUSED;
8010395b:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
    return 0;
80103962:	31 f6                	xor    %esi,%esi
    cprintf("failed kalloc");
80103964:	68 88 7c 10 80       	push   $0x80107c88
80103969:	e8 f2 cc ff ff       	call   80100660 <cprintf>
    return 0;
8010396e:	83 c4 10             	add    $0x10,%esp
80103971:	eb b8                	jmp    8010392b <allocproc+0xcb>
...
80103984:	83 ec 14             	sub    $0x14,%esp
  p = allocproc();
80103987:	e8 d4 fe ff ff       	call   80103860 <allocproc>
8010398c:	89 c3                	mov    %eax,%ebx
  initproc = p;
8010398e:	a3 b8 b5 10 80       	mov    %eax,0x8010b5b8
  if((p->pgdir = setupkvm()) == 0)
80103993:	e8 b8 3a 00 00       	call   80107450 <setupkvm>
80103998:	85 c0                	test   %eax,%eax
8010399a:	89 43 04             	mov    %eax,0x4(%ebx)
8010399d:	0f 84 d3 00 00 00    	je     80103a76 <userinit+0xf6>
...
801039b1:	e8 7a 37 00 00       	call   80107130 <inituvm>
...
801039c6:	e8 d5 11 00 00       	call   80104ba0 <memset>
...
80103a1f:	68 af 7c 10 80       	push   $0x80107caf
  if(!cas(&p->state,EMBRYO,RUNNABLE)){
80103a24:	83 c3 0c             	add    $0xc,%ebx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a27:	50                   	push   %eax
80103a28:	e8 53 13 00 00       	call   80104d80 <safestrcpy>
  p->cwd = namei("/");
80103a2d:	c7 04 24 b8 7c 10 80 	movl   $0x80107cb8,(%esp)
80103a34:	e8 d7 e4 ff ff       	call   80101f10 <namei>
80103a39:	89 43 60             	mov    %eax,0x60(%ebx)
  pushcli();
80103a3c:	e8 7f 0f 00 00       	call   801049c0 <pushcli>
80103a41:	b8 01 00 00 00       	mov    $0x1,%eax
80103a46:	ba 03 00 00 00       	mov    $0x3,%edx
80103a4b:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
80103a4f:	9c                   	pushf  
80103a50:	8f 45 f4             	popl   -0xc(%ebp)
  if(!cas(&p->state,EMBRYO,RUNNABLE)){
80103a53:	83 c4 10             	add    $0x10,%esp
80103a56:	f6 45 f4 40          	testb  $0x40,-0xc(%ebp)
80103a5a:	75 10                	jne    80103a6c <userinit+0xec>
    cprintf("user init cas err");
80103a5c:	83 ec 0c             	sub    $0xc,%esp
80103a5f:	68 ba 7c 10 80       	push   $0x80107cba
80103a64:	e8 f7 cb ff ff       	call   80100660 <cprintf>
80103a69:	83 c4 10             	add    $0x10,%esp
  popcli();
80103a6c:	e8 8f 0f 00 00       	call   80104a00 <popcli>
}
...
80103a79:	68 96 7c 10 80       	push   $0x80107c96
...
80103a95:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a98:	e8 23 0f 00 00       	call   801049c0 <pushcli>
  c = mycpu();
80103a9d:	e8 ae fc ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103aa2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa8:	e8 53 0f 00 00       	call   80104a00 <popcli>
  if(n > 0){
...
80103abc:	e8 5f 35 00 00       	call   80107020 <switchuvm>
  return 0;
...
80103ada:	e8 91 37 00 00       	call   80107270 <allocuvm>
...
80103afa:	e8 a1 38 00 00       	call   801073a0 <deallocuvm>
...
80103b16:	83 ec 2c             	sub    $0x2c,%esp
  pushcli();
80103b19:	e8 a2 0e 00 00       	call   801049c0 <pushcli>
  c = mycpu();
80103b1e:	e8 2d fc ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103b23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b29:	e8 d2 0e 00 00       	call   80104a00 <popcli>
  if((np = allocproc()) == 0){
80103b2e:	e8 2d fd ff ff       	call   80103860 <allocproc>
80103b33:	85 c0                	test   %eax,%eax
80103b35:	0f 84 27 01 00 00    	je     80103c62 <fork+0x152>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103b3b:	83 ec 08             	sub    $0x8,%esp
80103b3e:	ff 33                	pushl  (%ebx)
80103b40:	ff 73 04             	pushl  0x4(%ebx)
80103b43:	89 45 d4             	mov    %eax,-0x2c(%ebp)
80103b46:	e8 d5 39 00 00       	call   80107520 <copyuvm>
80103b4b:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80103b4e:	83 c4 10             	add    $0x10,%esp
80103b51:	85 c0                	test   %eax,%eax
80103b53:	89 42 04             	mov    %eax,0x4(%edx)
80103b56:	0f 84 1d 01 00 00    	je     80103c79 <fork+0x169>
  np->sz = curproc->sz;
80103b5c:	8b 03                	mov    (%ebx),%eax
  *np->tf = *curproc->tf;
80103b5e:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->parent = curproc;
80103b63:	89 5a 14             	mov    %ebx,0x14(%edx)
  *np->tf = *curproc->tf;
80103b66:	8b 7a 18             	mov    0x18(%edx),%edi
  np->sz = curproc->sz;
80103b69:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80103b6b:	8b 73 18             	mov    0x18(%ebx),%esi
80103b6e:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->signalMask = curproc->signalMask;
80103b70:	8b 83 84 00 00 00    	mov    0x84(%ebx),%eax
  np->pendingSignals = 0;
80103b76:	c7 82 80 00 00 00 00 	movl   $0x0,0x80(%edx)
80103b7d:	00 00 00 
  np->signalMask = curproc->signalMask;
80103b80:	89 82 84 00 00 00    	mov    %eax,0x84(%edx)
  for(int i = 0 ; i < 32 ; i++){
80103b86:	31 c0                	xor    %eax,%eax
80103b88:	90                   	nop
80103b89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    np->signalHandler[i] = curproc->signalHandler[i];
80103b90:	8b 8c 83 0c 01 00 00 	mov    0x10c(%ebx,%eax,4),%ecx
80103b97:	89 8c 82 0c 01 00 00 	mov    %ecx,0x10c(%edx,%eax,4)
    np->signalHandlerMasks[i] = curproc->signalHandlerMasks[i];
80103b9e:	8b 8c 83 8c 00 00 00 	mov    0x8c(%ebx,%eax,4),%ecx
80103ba5:	89 8c 82 8c 00 00 00 	mov    %ecx,0x8c(%edx,%eax,4)
  for(int i = 0 ; i < 32 ; i++){
80103bac:	83 c0 01             	add    $0x1,%eax
80103baf:	83 f8 20             	cmp    $0x20,%eax
80103bb2:	75 dc                	jne    80103b90 <fork+0x80>
  np->tf->eax = 0;
80103bb4:	8b 42 18             	mov    0x18(%edx),%eax
  for(i = 0; i < NOFILE; i++)
80103bb7:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103bb9:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
    if(curproc->ofile[i])
80103bc0:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
80103bc4:	85 c0                	test   %eax,%eax
80103bc6:	74 16                	je     80103bde <fork+0xce>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103bc8:	83 ec 0c             	sub    $0xc,%esp
80103bcb:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80103bce:	50                   	push   %eax
80103bcf:	e8 4c d2 ff ff       	call   80100e20 <filedup>
80103bd4:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80103bd7:	83 c4 10             	add    $0x10,%esp
80103bda:	89 44 b2 2c          	mov    %eax,0x2c(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103bde:	83 c6 01             	add    $0x1,%esi
80103be1:	83 fe 10             	cmp    $0x10,%esi
80103be4:	75 da                	jne    80103bc0 <fork+0xb0>
  np->cwd = idup(curproc->cwd);
80103be6:	83 ec 0c             	sub    $0xc,%esp
80103be9:	ff 73 6c             	pushl  0x6c(%ebx)
80103bec:	89 55 d4             	mov    %edx,-0x2c(%ebp)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bef:	83 c3 70             	add    $0x70,%ebx
  np->cwd = idup(curproc->cwd);
80103bf2:	e8 89 da ff ff       	call   80101680 <idup>
80103bf7:	8b 55 d4             	mov    -0x2c(%ebp),%edx
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bfa:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103bfd:	89 42 6c             	mov    %eax,0x6c(%edx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103c00:	8d 42 70             	lea    0x70(%edx),%eax
80103c03:	6a 10                	push   $0x10
80103c05:	53                   	push   %ebx
80103c06:	50                   	push   %eax
80103c07:	e8 74 11 00 00       	call   80104d80 <safestrcpy>
  pid = np->pid;
80103c0c:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80103c0f:	8b 72 10             	mov    0x10(%edx),%esi
  pushcli();
80103c12:	e8 a9 0d 00 00       	call   801049c0 <pushcli>
  if(!cas(&np->state,EMBRYO,RUNNABLE)){
80103c17:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80103c1a:	b8 01 00 00 00       	mov    $0x1,%eax
80103c1f:	8d 5a 0c             	lea    0xc(%edx),%ebx
80103c22:	ba 03 00 00 00       	mov    $0x3,%edx
80103c27:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
80103c2b:	9c                   	pushf  
80103c2c:	8f 45 e4             	popl   -0x1c(%ebp)
80103c2f:	83 c4 10             	add    $0x10,%esp
80103c32:	f6 45 e4 40          	testb  $0x40,-0x1c(%ebp)
80103c36:	74 18                	je     80103c50 <fork+0x140>
  popcli();
80103c38:	e8 c3 0d 00 00       	call   80104a00 <popcli>
}
80103c3d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103c40:	89 f0                	mov    %esi,%eax
80103c42:	5b                   	pop    %ebx
80103c43:	5e                   	pop    %esi
80103c44:	5f                   	pop    %edi
80103c45:	5d                   	pop    %ebp
...
80103c53:	68 f6 7c 10 80       	push   $0x80107cf6
80103c58:	e8 03 ca ff ff       	call   80100660 <cprintf>
80103c5d:	83 c4 10             	add    $0x10,%esp
80103c60:	eb d6                	jmp    80103c38 <fork+0x128>
    cprintf("failed in allocproc\n\n");
80103c62:	83 ec 0c             	sub    $0xc,%esp
    return -1;
80103c65:	be ff ff ff ff       	mov    $0xffffffff,%esi
    cprintf("failed in allocproc\n\n");
80103c6a:	68 cc 7c 10 80       	push   $0x80107ccc
80103c6f:	e8 ec c9 ff ff       	call   80100660 <cprintf>
    return -1;
80103c74:	83 c4 10             	add    $0x10,%esp
80103c77:	eb c4                	jmp    80103c3d <fork+0x12d>
    kfree(np->kstack);
80103c79:	83 ec 0c             	sub    $0xc,%esp
80103c7c:	ff 72 08             	pushl  0x8(%edx)
    return -1;
80103c7f:	be ff ff ff ff       	mov    $0xffffffff,%esi
    kfree(np->kstack);
80103c84:	e8 c7 e6 ff ff       	call   80102350 <kfree>
    np->kstack = 0;
80103c89:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80103c8c:	c7 42 08 00 00 00 00 	movl   $0x0,0x8(%edx)
    np->state = UNUSED;
80103c93:	c7 42 0c 00 00 00 00 	movl   $0x0,0xc(%edx)
    cprintf("failed in copyuvm\n\n");
80103c9a:	c7 04 24 e2 7c 10 80 	movl   $0x80107ce2,(%esp)
80103ca1:	e8 ba c9 ff ff       	call   80100660 <cprintf>
    return -1;
80103ca6:	83 c4 10             	add    $0x10,%esp
80103ca9:	eb 92                	jmp    80103c3d <fork+0x12d>
80103cab:	90                   	nop
...
80103cb6:	83 ec 2c             	sub    $0x2c,%esp
  struct cpu *c = mycpu();
80103cb9:	e8 92 fa ff ff       	call   80103750 <mycpu>
  c->proc = 0;
...
80103cce:	89 45 d0             	mov    %eax,-0x30(%ebp)
80103cd1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  asm volatile("sti");
80103cd8:	fb                   	sti    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cd9:	bf 54 3d 11 80       	mov    $0x80113d54,%edi
  asm volatile("lock; cmpxchgl %3, (%2)\n\t"
80103cde:	be fc ff ff ff       	mov    $0xfffffffc,%esi
    pushcli();
80103ce3:	e8 d8 0c 00 00       	call   801049c0 <pushcli>
80103ce8:	90                   	nop
80103ce9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->frozen == 1)
80103cf0:	83 7f 28 01          	cmpl   $0x1,0x28(%edi)
80103cf4:	0f 84 9d 00 00 00    	je     80103d97 <scheduler+0xe7>
80103cfa:	8d 5f 0c             	lea    0xc(%edi),%ebx
80103cfd:	b8 03 00 00 00       	mov    $0x3,%eax
80103d02:	f0 0f b1 33          	lock cmpxchg %esi,(%ebx)
80103d06:	9c                   	pushf  
80103d07:	8f 45 e4             	popl   -0x1c(%ebp)
      if(!cas(&p->state, RUNNABLE, -RUNNING))
80103d0a:	f6 45 e4 40          	testb  $0x40,-0x1c(%ebp)
80103d0e:	0f 84 83 00 00 00    	je     80103d97 <scheduler+0xe7>
      c->proc = p;
80103d14:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      switchuvm(p);
80103d17:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103d1a:	89 ba ac 00 00 00    	mov    %edi,0xac(%edx)
      switchuvm(p);
80103d20:	57                   	push   %edi
80103d21:	e8 fa 32 00 00       	call   80107020 <switchuvm>
80103d26:	b9 04 00 00 00       	mov    $0x4,%ecx
80103d2b:	89 f0                	mov    %esi,%eax
80103d2d:	f0 0f b1 0b          	lock cmpxchg %ecx,(%ebx)
80103d31:	9c                   	pushf  
80103d32:	8f 45 e4             	popl   -0x1c(%ebp)
      swtch(&(c->scheduler), p->context);
80103d35:	58                   	pop    %eax
80103d36:	5a                   	pop    %edx
80103d37:	ff 77 1c             	pushl  0x1c(%edi)
80103d3a:	ff 75 d0             	pushl  -0x30(%ebp)
80103d3d:	e8 99 10 00 00       	call   80104ddb <swtch>
      switchkvm();
80103d42:	e8 b9 32 00 00       	call   80107000 <switchkvm>
      c->proc = 0;
80103d47:	8b 55 d4             	mov    -0x2c(%ebp),%edx
80103d4a:	b8 fd ff ff ff       	mov    $0xfffffffd,%eax
80103d4f:	c7 82 ac 00 00 00 00 	movl   $0x0,0xac(%edx)
80103d56:	00 00 00 
80103d59:	ba 03 00 00 00       	mov    $0x3,%edx
80103d5e:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
80103d62:	9c                   	pushf  
80103d63:	8f 45 e4             	popl   -0x1c(%ebp)
80103d66:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80103d6b:	b9 02 00 00 00       	mov    $0x2,%ecx
80103d70:	f0 0f b1 0b          	lock cmpxchg %ecx,(%ebx)
80103d74:	9c                   	pushf  
80103d75:	8f 45 e4             	popl   -0x1c(%ebp)
80103d78:	b8 fb ff ff ff       	mov    $0xfffffffb,%eax
80103d7d:	b9 05 00 00 00       	mov    $0x5,%ecx
80103d82:	f0 0f b1 0b          	lock cmpxchg %ecx,(%ebx)
80103d86:	9c                   	pushf  
80103d87:	8f 45 e4             	popl   -0x1c(%ebp)
80103d8a:	31 c0                	xor    %eax,%eax
80103d8c:	f0 0f b1 03          	lock cmpxchg %eax,(%ebx)
80103d90:	9c                   	pushf  
80103d91:	8f 45 e4             	popl   -0x1c(%ebp)
80103d94:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d97:	81 c7 90 01 00 00    	add    $0x190,%edi
80103d9d:	81 ff 54 a1 11 80    	cmp    $0x8011a154,%edi
80103da3:	0f 82 47 ff ff ff    	jb     80103cf0 <scheduler+0x40>
    popcli();
80103da9:	e8 52 0c 00 00       	call   80104a00 <popcli>
    sti();
80103dae:	e9 25 ff ff ff       	jmp    80103cd8 <scheduler+0x28>
...
80103dc4:	53                   	push   %ebx
  pushcli();
80103dc5:	e8 f6 0b 00 00       	call   801049c0 <pushcli>
  c = mycpu();
80103dca:	e8 81 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103dcf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dd5:	e8 26 0c 00 00       	call   80104a00 <popcli>
  if(mycpu()->ncli != 1)
80103dda:	e8 71 f9 ff ff       	call   80103750 <mycpu>
80103ddf:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103de6:	75 43                	jne    80103e2b <sched+0x6b>
  if(p->state == RUNNING)
80103de8:	8b 43 0c             	mov    0xc(%ebx),%eax
80103deb:	83 f8 04             	cmp    $0x4,%eax
80103dee:	74 55                	je     80103e45 <sched+0x85>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80103df0:	9c                   	pushf  
80103df1:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103df2:	f6 c4 02             	test   $0x2,%ah
80103df5:	75 41                	jne    80103e38 <sched+0x78>
  intena = mycpu()->intena;
80103df7:	e8 54 f9 ff ff       	call   80103750 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103dfc:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103dff:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e05:	e8 46 f9 ff ff       	call   80103750 <mycpu>
80103e0a:	83 ec 08             	sub    $0x8,%esp
80103e0d:	ff 70 04             	pushl  0x4(%eax)
80103e10:	53                   	push   %ebx
80103e11:	e8 c5 0f 00 00       	call   80104ddb <swtch>
  mycpu()->intena = intena;
80103e16:	e8 35 f9 ff ff       	call   80103750 <mycpu>
}
80103e1b:	83 c4 10             	add    $0x10,%esp
  mycpu()->intena = intena;
80103e1e:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
80103e24:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103e27:	5b                   	pop    %ebx
80103e28:	5e                   	pop    %esi
80103e29:	5d                   	pop    %ebp
80103e2a:	c3                   	ret    
...
80103e66:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103e69:	e8 52 0b 00 00       	call   801049c0 <pushcli>
  c = mycpu();
80103e6e:	e8 dd f8 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103e73:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e79:	e8 82 0b 00 00       	call   80104a00 <popcli>
  if(curproc == initproc)
80103e7e:	39 35 b8 b5 10 80    	cmp    %esi,0x8010b5b8
80103e84:	8d 5e 2c             	lea    0x2c(%esi),%ebx
80103e87:	8d 7e 6c             	lea    0x6c(%esi),%edi
80103e8a:	0f 84 d7 00 00 00    	je     80103f67 <exit+0x107>
    if(curproc->ofile[fd]){
...
80103e9a:	e8 d1 cf ff ff       	call   80100e70 <fileclose>
      curproc->ofile[fd] = 0;
...
80103ead:	75 e1                	jne    80103e90 <exit+0x30>
  begin_op();
80103eaf:	e8 2c ed ff ff       	call   80102be0 <begin_op>
  iput(curproc->cwd);
80103eb4:	83 ec 0c             	sub    $0xc,%esp
80103eb7:	ff 76 6c             	pushl  0x6c(%esi)
  if(!cas(&curproc->state,RUNNING,-ZOMBIE)){
80103eba:	8d 5e 0c             	lea    0xc(%esi),%ebx
  iput(curproc->cwd);
80103ebd:	e8 1e d9 ff ff       	call   801017e0 <iput>
  end_op();
80103ec2:	e8 89 ed ff ff       	call   80102c50 <end_op>
  curproc->cwd = 0;
80103ec7:	c7 46 6c 00 00 00 00 	movl   $0x0,0x6c(%esi)
  pushcli();
80103ece:	e8 ed 0a 00 00       	call   801049c0 <pushcli>
  asm volatile("lock; cmpxchgl %3, (%2)\n\t"
80103ed3:	b8 04 00 00 00       	mov    $0x4,%eax
80103ed8:	ba fb ff ff ff       	mov    $0xfffffffb,%edx
80103edd:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
80103ee1:	9c                   	pushf  
80103ee2:	8f 45 e4             	popl   -0x1c(%ebp)
  if(!cas(&curproc->state,RUNNING,-ZOMBIE)){
80103ee5:	83 c4 10             	add    $0x10,%esp
80103ee8:	f6 45 e4 40          	testb  $0x40,-0x1c(%ebp)
80103eec:	74 64                	je     80103f52 <exit+0xf2>
  wakeup1(curproc->parent);
80103eee:	8b 46 14             	mov    0x14(%esi),%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ef1:	bb 54 3d 11 80       	mov    $0x80113d54,%ebx
  wakeup1(curproc->parent);
80103ef6:	e8 45 f7 ff ff       	call   80103640 <wakeup1>
80103efb:	eb 11                	jmp    80103f0e <exit+0xae>
80103efd:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f00:	81 c3 90 01 00 00    	add    $0x190,%ebx
80103f06:	81 fb 54 a1 11 80    	cmp    $0x8011a154,%ebx
80103f0c:	73 32                	jae    80103f40 <exit+0xe0>
    if(p->parent == curproc){
80103f0e:	39 73 14             	cmp    %esi,0x14(%ebx)
80103f11:	75 ed                	jne    80103f00 <exit+0xa0>
      if(p->state == ZOMBIE)
80103f13:	8b 53 0c             	mov    0xc(%ebx),%edx
      p->parent = initproc;
80103f16:	a1 b8 b5 10 80       	mov    0x8010b5b8,%eax
      if(p->state == ZOMBIE)
80103f1b:	83 fa 05             	cmp    $0x5,%edx
      p->parent = initproc;
80103f1e:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
80103f21:	75 dd                	jne    80103f00 <exit+0xa0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f23:	81 c3 90 01 00 00    	add    $0x190,%ebx
        wakeup1(initproc);
80103f29:	e8 12 f7 ff ff       	call   80103640 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f2e:	81 fb 54 a1 11 80    	cmp    $0x8011a154,%ebx
80103f34:	72 d8                	jb     80103f0e <exit+0xae>
80103f36:	8d 76 00             	lea    0x0(%esi),%esi
80103f39:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  sched();
80103f40:	e8 7b fe ff ff       	call   80103dc0 <sched>
  panic("zombie exit");
80103f45:	83 ec 0c             	sub    $0xc,%esp
80103f48:	68 51 7d 10 80       	push   $0x80107d51
80103f4d:	e8 3e c4 ff ff       	call   80100390 <panic>
    cprintf("exit cas err %d\n",curproc->state);
80103f52:	8b 46 0c             	mov    0xc(%esi),%eax
80103f55:	52                   	push   %edx
80103f56:	52                   	push   %edx
80103f57:	50                   	push   %eax
80103f58:	68 40 7d 10 80       	push   $0x80107d40
80103f5d:	e8 fe c6 ff ff       	call   80100660 <cprintf>
80103f62:	83 c4 10             	add    $0x10,%esp
80103f65:	eb 87                	jmp    80103eee <exit+0x8e>
    panic("init exiting");
80103f67:	83 ec 0c             	sub    $0xc,%esp
80103f6a:	68 33 7d 10 80       	push   $0x80107d33
...
80103f84:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80103f87:	e8 34 0a 00 00       	call   801049c0 <pushcli>
  pushcli();
80103f8c:	e8 2f 0a 00 00       	call   801049c0 <pushcli>
  c = mycpu();
80103f91:	e8 ba f7 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103f96:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f9c:	e8 5f 0a 00 00       	call   80104a00 <popcli>
80103fa1:	b8 04 00 00 00       	mov    $0x4,%eax
80103fa6:	ba fd ff ff ff       	mov    $0xfffffffd,%edx
  if(!cas(&myproc()->state,RUNNING, -RUNNABLE)){
80103fab:	83 c3 0c             	add    $0xc,%ebx
80103fae:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
80103fb2:	9c                   	pushf  
80103fb3:	8f 45 f4             	popl   -0xc(%ebp)
80103fb6:	f6 45 f4 40          	testb  $0x40,-0xc(%ebp)
80103fba:	75 10                	jne    80103fcc <yield+0x4c>
    cprintf("yeild cas err");
80103fbc:	83 ec 0c             	sub    $0xc,%esp
80103fbf:	68 5d 7d 10 80       	push   $0x80107d5d
80103fc4:	e8 97 c6 ff ff       	call   80100660 <cprintf>
80103fc9:	83 c4 10             	add    $0x10,%esp
  sched();
80103fcc:	e8 ef fd ff ff       	call   80103dc0 <sched>
  popcli();
80103fd1:	e8 2a 0a 00 00       	call   80104a00 <popcli>
}
...
80103fe9:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pushcli();
80103fec:	e8 cf 09 00 00       	call   801049c0 <pushcli>
  c = mycpu();
80103ff1:	e8 5a f7 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103ff6:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ffc:	e8 ff 09 00 00       	call   80104a00 <popcli>
  if(p == 0)
80104001:	85 f6                	test   %esi,%esi
80104003:	0f 84 9a 00 00 00    	je     801040a3 <sleep+0xc3>
  if(lk == 0)
80104009:	85 ff                	test   %edi,%edi
8010400b:	0f 84 85 00 00 00    	je     80104096 <sleep+0xb6>
  if(lk != &ptable.lock){  //DOC: sleeplock0
80104011:	81 ff 20 3d 11 80    	cmp    $0x80113d20,%edi
80104017:	74 11                	je     8010402a <sleep+0x4a>
    pushcli();
80104019:	e8 a2 09 00 00       	call   801049c0 <pushcli>
    release(lk);
8010401e:	83 ec 0c             	sub    $0xc,%esp
80104021:	57                   	push   %edi
80104022:	e8 29 0b 00 00       	call   80104b50 <release>
80104027:	83 c4 10             	add    $0x10,%esp
  if(!cas(&p->state,RUNNING,-SLEEPING)){
8010402a:	8d 5e 0c             	lea    0xc(%esi),%ebx
8010402d:	b8 04 00 00 00       	mov    $0x4,%eax
80104032:	ba fe ff ff ff       	mov    $0xfffffffe,%edx
80104037:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
8010403b:	9c                   	pushf  
8010403c:	8f 45 e4             	popl   -0x1c(%ebp)
8010403f:	f6 45 e4 40          	testb  $0x40,-0x1c(%ebp)
80104043:	74 3b                	je     80104080 <sleep+0xa0>
  p->chan = chan;
80104045:	8b 45 08             	mov    0x8(%ebp),%eax
80104048:	89 46 20             	mov    %eax,0x20(%esi)
  sched();
8010404b:	e8 70 fd ff ff       	call   80103dc0 <sched>
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104050:	81 ff 20 3d 11 80    	cmp    $0x80113d20,%edi
  p->chan = 0;
80104056:	c7 46 20 00 00 00 00 	movl   $0x0,0x20(%esi)
  if(lk != &ptable.lock){  //DOC: sleeplock2
8010405d:	74 11                	je     80104070 <sleep+0x90>
    popcli();
8010405f:	e8 9c 09 00 00       	call   80104a00 <popcli>
    acquire(lk);
80104064:	83 ec 0c             	sub    $0xc,%esp
80104067:	57                   	push   %edi
80104068:	e8 23 0a 00 00       	call   80104a90 <acquire>
8010406d:	83 c4 10             	add    $0x10,%esp
}
80104070:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104073:	5b                   	pop    %ebx
80104074:	5e                   	pop    %esi
80104075:	5f                   	pop    %edi
80104076:	5d                   	pop    %ebp
...
80104080:	8b 46 0c             	mov    0xc(%esi),%eax
80104083:	83 ec 08             	sub    $0x8,%esp
80104086:	50                   	push   %eax
80104087:	68 82 7d 10 80       	push   $0x80107d82
8010408c:	e8 cf c5 ff ff       	call   80100660 <cprintf>
80104091:	83 c4 10             	add    $0x10,%esp
80104094:	eb af                	jmp    80104045 <sleep+0x65>
    panic("sleep without lk");
80104096:	83 ec 0c             	sub    $0xc,%esp
80104099:	68 71 7d 10 80       	push   $0x80107d71
8010409e:	e8 ed c2 ff ff       	call   80100390 <panic>
    panic("sleep");
801040a3:	83 ec 0c             	sub    $0xc,%esp
801040a6:	68 6b 7d 10 80       	push   $0x80107d6b
...
801040b6:	83 ec 2c             	sub    $0x2c,%esp
  pushcli();
801040b9:	e8 02 09 00 00       	call   801049c0 <pushcli>
  c = mycpu();
801040be:	e8 8d f6 ff ff       	call   80103750 <mycpu>
  p = c->proc;
801040c3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801040c9:	e8 32 09 00 00       	call   80104a00 <popcli>
  pushcli();
801040ce:	e8 ed 08 00 00       	call   801049c0 <pushcli>
801040d3:	8d 46 0c             	lea    0xc(%esi),%eax
801040d6:	89 45 d4             	mov    %eax,-0x2c(%ebp)
801040d9:	b8 04 00 00 00       	mov    $0x4,%eax
801040de:	ba fe ff ff ff       	mov    $0xfffffffe,%edx
801040e3:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
801040e6:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
801040ea:	9c                   	pushf  
801040eb:	8f 45 e4             	popl   -0x1c(%ebp)
    if(!cas(&curproc->state,RUNNING,-SLEEPING)){
801040ee:	f6 45 e4 40          	testb  $0x40,-0x1c(%ebp)
801040f2:	0f 84 b8 00 00 00    	je     801041b0 <wait+0x100>
{
801040f8:	31 c9                	xor    %ecx,%ecx
801040fa:	bf 54 3d 11 80       	mov    $0x80113d54,%edi
801040ff:	eb 15                	jmp    80104116 <wait+0x66>
80104101:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104108:	81 c7 90 01 00 00    	add    $0x190,%edi
8010410e:	81 ff 54 a1 11 80    	cmp    $0x8011a154,%edi
80104114:	73 5e                	jae    80104174 <wait+0xc4>
      if(p->parent != curproc)
80104116:	39 77 14             	cmp    %esi,0x14(%edi)
80104119:	75 ed                	jne    80104108 <wait+0x58>
      while(p->state == -ZOMBIE){cprintf("neg zombie");}
8010411b:	8b 47 0c             	mov    0xc(%edi),%eax
8010411e:	83 f8 fb             	cmp    $0xfffffffb,%eax
80104121:	75 1d                	jne    80104140 <wait+0x90>
80104123:	90                   	nop
80104124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104128:	83 ec 0c             	sub    $0xc,%esp
8010412b:	68 a4 7d 10 80       	push   $0x80107da4
80104130:	e8 2b c5 ff ff       	call   80100660 <cprintf>
80104135:	8b 47 0c             	mov    0xc(%edi),%eax
80104138:	83 c4 10             	add    $0x10,%esp
8010413b:	83 f8 fb             	cmp    $0xfffffffb,%eax
8010413e:	74 e8                	je     80104128 <wait+0x78>
80104140:	8d 4f 0c             	lea    0xc(%edi),%ecx
80104143:	b8 05 00 00 00       	mov    $0x5,%eax
80104148:	ba 07 00 00 00       	mov    $0x7,%edx
8010414d:	89 cb                	mov    %ecx,%ebx
8010414f:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
80104153:	9c                   	pushf  
80104154:	8f 45 e4             	popl   -0x1c(%ebp)
      if(cas(&p->state ,ZOMBIE, PRE_UNUSED)){
80104157:	f6 45 e4 40          	testb  $0x40,-0x1c(%ebp)
8010415b:	0f 85 9f 00 00 00    	jne    80104200 <wait+0x150>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104161:	81 c7 90 01 00 00    	add    $0x190,%edi
      havekids = 1;
80104167:	b9 01 00 00 00       	mov    $0x1,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010416c:	81 ff 54 a1 11 80    	cmp    $0x8011a154,%edi
80104172:	72 a2                	jb     80104116 <wait+0x66>
80104174:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80104179:	ba 04 00 00 00       	mov    $0x4,%edx
8010417e:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
80104181:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
80104185:	9c                   	pushf  
80104186:	8f 45 e4             	popl   -0x1c(%ebp)
    if(!cas(&curproc->state,-SLEEPING,RUNNING)){
80104189:	f6 45 e4 40          	testb  $0x40,-0x1c(%ebp)
8010418d:	74 39                	je     801041c8 <wait+0x118>
    if(!havekids || curproc->killed){
8010418f:	85 c9                	test   %ecx,%ecx
80104191:	74 53                	je     801041e6 <wait+0x136>
80104193:	8b 46 24             	mov    0x24(%esi),%eax
80104196:	85 c0                	test   %eax,%eax
80104198:	75 4c                	jne    801041e6 <wait+0x136>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
8010419a:	83 ec 08             	sub    $0x8,%esp
8010419d:	68 20 3d 11 80       	push   $0x80113d20
801041a2:	56                   	push   %esi
801041a3:	e8 38 fe ff ff       	call   80103fe0 <sleep>
    if(!cas(&curproc->state,RUNNING,-SLEEPING)){
801041a8:	83 c4 10             	add    $0x10,%esp
801041ab:	e9 29 ff ff ff       	jmp    801040d9 <wait+0x29>
      cprintf("wait cas err1\n");
801041b0:	83 ec 0c             	sub    $0xc,%esp
801041b3:	68 95 7d 10 80       	push   $0x80107d95
801041b8:	e8 a3 c4 ff ff       	call   80100660 <cprintf>
801041bd:	83 c4 10             	add    $0x10,%esp
801041c0:	e9 33 ff ff ff       	jmp    801040f8 <wait+0x48>
801041c5:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("wait cas err2 %d\n",curproc->state);
801041c8:	8b 46 0c             	mov    0xc(%esi),%eax
801041cb:	83 ec 08             	sub    $0x8,%esp
801041ce:	89 4d d0             	mov    %ecx,-0x30(%ebp)
801041d1:	50                   	push   %eax
801041d2:	68 af 7d 10 80       	push   $0x80107daf
801041d7:	e8 84 c4 ff ff       	call   80100660 <cprintf>
801041dc:	8b 4d d0             	mov    -0x30(%ebp),%ecx
801041df:	83 c4 10             	add    $0x10,%esp
    if(!havekids || curproc->killed){
801041e2:	85 c9                	test   %ecx,%ecx
801041e4:	75 ad                	jne    80104193 <wait+0xe3>
      popcli();
801041e6:	e8 15 08 00 00       	call   80104a00 <popcli>
}
801041eb:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
801041ee:	be ff ff ff ff       	mov    $0xffffffff,%esi
}
801041f3:	89 f0                	mov    %esi,%eax
801041f5:	5b                   	pop    %ebx
801041f6:	5e                   	pop    %esi
801041f7:	5f                   	pop    %edi
801041f8:	5d                   	pop    %ebp
...
80104203:	ff 77 08             	pushl  0x8(%edi)
80104206:	89 4d d0             	mov    %ecx,-0x30(%ebp)
        pid = p->pid;
80104209:	8b 77 10             	mov    0x10(%edi),%esi
        kfree(p->kstack);
8010420c:	e8 3f e1 ff ff       	call   80102350 <kfree>
        freevm(p->pgdir);
80104211:	5a                   	pop    %edx
80104212:	ff 77 04             	pushl  0x4(%edi)
        p->kstack = 0;
80104215:	c7 47 08 00 00 00 00 	movl   $0x0,0x8(%edi)
        freevm(p->pgdir);
8010421c:	e8 af 31 00 00       	call   801073d0 <freevm>
        p->pid = 0;
80104221:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
        p->parent = 0;
80104228:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
8010422f:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
        p->name[0] = 0;
80104234:	c6 47 70 00          	movb   $0x0,0x70(%edi)
        p->killed = 0;
80104238:	c7 47 24 00 00 00 00 	movl   $0x0,0x24(%edi)
8010423f:	ba 04 00 00 00       	mov    $0x4,%edx
80104244:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
80104247:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
8010424b:	9c                   	pushf  
8010424c:	8f 45 e4             	popl   -0x1c(%ebp)
8010424f:	8b 4d d0             	mov    -0x30(%ebp),%ecx
80104252:	31 d2                	xor    %edx,%edx
80104254:	b8 07 00 00 00       	mov    $0x7,%eax
80104259:	89 cb                	mov    %ecx,%ebx
8010425b:	f0 0f b1 13          	lock cmpxchg %edx,(%ebx)
8010425f:	9c                   	pushf  
80104260:	8f 45 e4             	popl   -0x1c(%ebp)
        popcli();
80104263:	e8 98 07 00 00       	call   80104a00 <popcli>
        return pid;
...
80104287:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010428a:	e8 31 07 00 00       	call   801049c0 <pushcli>
  wakeup1(chan);
8010428f:	89 d8                	mov    %ebx,%eax
80104291:	e8 aa f3 ff ff       	call   80103640 <wakeup1>
  popcli();
}
...
8010429a:	5d                   	pop    %ebp
  popcli();
8010429b:	e9 60 07 00 00       	jmp    80104a00 <popcli>
...
801042af:	83 fe 1f             	cmp    $0x1f,%esi
801042b2:	0f 87 d2 00 00 00    	ja     8010438a <kill+0xea>
    return -1;
  }
  ...
  //acquire(&ptable.lock);
  pushcli();
801042b8:	e8 03 07 00 00       	call   801049c0 <pushcli>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042bd:	ba 54 3d 11 80       	mov    $0x80113d54,%edx
801042c2:	eb 16                	jmp    801042da <kill+0x3a>
801042c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801042c8:	81 c2 90 01 00 00    	add    $0x190,%edx
801042ce:	81 fa 54 a1 11 80    	cmp    $0x8011a154,%edx
801042d4:	0f 83 9e 00 00 00    	jae    80104378 <kill+0xd8>
    if(p->pid == pid && p->state !=UNUSED){
801042da:	39 5a 10             	cmp    %ebx,0x10(%edx)
801042dd:	75 e9                	jne    801042c8 <kill+0x28>
801042df:	8b 42 0c             	mov    0xc(%edx),%eax
801042e2:	85 c0                	test   %eax,%eax
801042e4:	74 e2                	je     801042c8 <kill+0x28>
      //p->killed = 1; TODO : add this to SIGKILL
      // Wake process from sleep if necessary.
      p->pendingSignals |= (1 << signum);
801042e6:	bf 01 00 00 00       	mov    $0x1,%edi
801042eb:	89 f1                	mov    %esi,%ecx
801042ed:	d3 e7                	shl    %cl,%edi
801042ef:	09 ba 80 00 00 00    	or     %edi,0x80(%edx)
      //check for unblockable sigs
      if((signum==SIGKILL)&&((p->state == SLEEPING) || (p->state == -SLEEPING))){
801042f5:	83 fe 09             	cmp    $0x9,%esi
801042f8:	74 28                	je     80104322 <kill+0x82>
        while(p->state == -SLEEPING);
...
801042fa:	83 fe 13             	cmp    $0x13,%esi
801042fd:	75 0a                	jne    80104309 <kill+0x69>
801042ff:	8b 82 58 01 00 00    	mov    0x158(%edx),%eax
80104305:	85 c0                	test   %eax,%eax
80104307:	74 57                	je     80104360 <kill+0xc0>
80104309:	83 bc b2 0c 01 00 00 	cmpl   $0x13,0x10c(%edx,%esi,4)
80104310:	13 
80104311:	74 4d                	je     80104360 <kill+0xc0>
      ...
      //release(&ptable.lock);
      popcli();
80104313:	e8 e8 06 00 00       	call   80104a00 <popcli>
      return 0;
...
8010431a:	83 c4 1c             	add    $0x1c,%esp
8010431d:	5b                   	pop    %ebx
8010431e:	5e                   	pop    %esi
8010431f:	5f                   	pop    %edi
80104320:	5d                   	pop    %ebp
80104321:	c3                   	ret    
      if((signum==SIGKILL)&&((p->state == SLEEPING) || (p->state == -SLEEPING))){
80104322:	8b 42 0c             	mov    0xc(%edx),%eax
80104325:	83 f8 02             	cmp    $0x2,%eax
80104328:	74 0e                	je     80104338 <kill+0x98>
8010432a:	8b 42 0c             	mov    0xc(%edx),%eax
8010432d:	83 f8 fe             	cmp    $0xfffffffe,%eax
80104330:	75 d7                	jne    80104309 <kill+0x69>
80104332:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        while(p->state == -SLEEPING);
80104338:	8b 42 0c             	mov    0xc(%edx),%eax
8010433b:	83 f8 fe             	cmp    $0xfffffffe,%eax
8010433e:	74 f8                	je     80104338 <kill+0x98>
        cas(&p->state, SLEEPING, RUNNABLE);
80104340:	8d 5a 0c             	lea    0xc(%edx),%ebx
80104343:	b8 02 00 00 00       	mov    $0x2,%eax
80104348:	b9 03 00 00 00       	mov    $0x3,%ecx
8010434d:	f0 0f b1 0b          	lock cmpxchg %ecx,(%ebx)
80104351:	9c                   	pushf  
80104352:	8f 45 e4             	popl   -0x1c(%ebp)
      if(((signum==SIGCONT)&&p->signalHandler[signum]==(void*)SIG_DFL)||(p->signalHandler[signum]==(void*)SIGCONT)){
80104355:	83 bc b2 0c 01 00 00 	cmpl   $0x13,0x10c(%edx,%esi,4)
8010435c:	13 
8010435d:	75 b4                	jne    80104313 <kill+0x73>
8010435f:	90                   	nop
        if((p->signalMask & (1 << signum)) == 0){
80104360:	85 ba 84 00 00 00    	test   %edi,0x84(%edx)
80104366:	75 ab                	jne    80104313 <kill+0x73>
          p->frozen=0;
80104368:	c7 42 28 00 00 00 00 	movl   $0x0,0x28(%edx)
8010436f:	eb a2                	jmp    80104313 <kill+0x73>
80104371:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  popcli();
80104378:	e8 83 06 00 00       	call   80104a00 <popcli>
}
8010437d:	83 c4 1c             	add    $0x1c,%esp
  return -1;
...
8010438f:	eb 89                	jmp    8010431a <kill+0x7a>
...
801043a5:	53                   	push   %ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043a6:	bb 54 3d 11 80       	mov    $0x80113d54,%ebx
{
801043ab:	83 ec 3c             	sub    $0x3c,%esp
801043ae:	eb 22                	jmp    801043d2 <procdump+0x32>
    if(p->state == SLEEPING){
...
801043b3:	68 e0 7c 10 80       	push   $0x80107ce0
801043b8:	e8 a3 c2 ff ff       	call   80100660 <cprintf>
801043bd:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043c0:	81 c3 90 01 00 00    	add    $0x190,%ebx
801043c6:	81 fb 54 a1 11 80    	cmp    $0x8011a154,%ebx
801043cc:	0f 83 9e 00 00 00    	jae    80104470 <procdump+0xd0>
    if(p->state == UNUSED)
801043d2:	8b 43 0c             	mov    0xc(%ebx),%eax
801043d5:	85 c0                	test   %eax,%eax
801043d7:	74 e7                	je     801043c0 <procdump+0x20>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801043d9:	8b 43 0c             	mov    0xc(%ebx),%eax
801043dc:	8b 53 0c             	mov    0xc(%ebx),%edx
      state = "???";
801043df:	b8 c1 7d 10 80       	mov    $0x80107dc1,%eax
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801043e4:	83 fa 05             	cmp    $0x5,%edx
801043e7:	77 18                	ja     80104401 <procdump+0x61>
801043e9:	8b 53 0c             	mov    0xc(%ebx),%edx
801043ec:	8b 14 95 1c 7e 10 80 	mov    -0x7fef81e4(,%edx,4),%edx
801043f3:	85 d2                	test   %edx,%edx
801043f5:	74 0a                	je     80104401 <procdump+0x61>
      state = states[p->state];
801043f7:	8b 43 0c             	mov    0xc(%ebx),%eax
801043fa:	8b 04 85 1c 7e 10 80 	mov    -0x7fef81e4(,%eax,4),%eax
    cprintf("%d %s %s", p->pid, state, p->name);
80104401:	8d 53 70             	lea    0x70(%ebx),%edx
80104404:	52                   	push   %edx
80104405:	50                   	push   %eax
80104406:	ff 73 10             	pushl  0x10(%ebx)
80104409:	68 c5 7d 10 80       	push   $0x80107dc5
8010440e:	e8 4d c2 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
80104413:	8b 43 0c             	mov    0xc(%ebx),%eax
80104416:	83 c4 10             	add    $0x10,%esp
80104419:	83 f8 02             	cmp    $0x2,%eax
8010441c:	75 92                	jne    801043b0 <procdump+0x10>
      getcallerpcs((uint*)p->context->ebp+2, pc);
8010441e:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104421:	83 ec 08             	sub    $0x8,%esp
80104424:	8d 75 c0             	lea    -0x40(%ebp),%esi
80104427:	8d 7d e8             	lea    -0x18(%ebp),%edi
8010442a:	50                   	push   %eax
8010442b:	8b 43 1c             	mov    0x1c(%ebx),%eax
8010442e:	8b 40 0c             	mov    0xc(%eax),%eax
80104431:	83 c0 08             	add    $0x8,%eax
80104434:	50                   	push   %eax
80104435:	e8 36 05 00 00       	call   80104970 <getcallerpcs>
8010443a:	83 c4 10             	add    $0x10,%esp
8010443d:	8d 76 00             	lea    0x0(%esi),%esi
      for(i=0; i<10 && pc[i] != 0; i++)
80104440:	8b 16                	mov    (%esi),%edx
80104442:	85 d2                	test   %edx,%edx
80104444:	0f 84 66 ff ff ff    	je     801043b0 <procdump+0x10>
        cprintf(" %p", pc[i]);
8010444a:	83 ec 08             	sub    $0x8,%esp
8010444d:	83 c6 04             	add    $0x4,%esi
80104450:	52                   	push   %edx
80104451:	68 41 77 10 80       	push   $0x80107741
80104456:	e8 05 c2 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
8010445b:	83 c4 10             	add    $0x10,%esp
8010445e:	39 f7                	cmp    %esi,%edi
80104460:	75 de                	jne    80104440 <procdump+0xa0>
80104462:	e9 49 ff ff ff       	jmp    801043b0 <procdump+0x10>
...
80104484:	53                   	push   %ebx
  pushcli();
80104485:	e8 36 05 00 00       	call   801049c0 <pushcli>
  c = mycpu();
8010448a:	e8 c1 f2 ff ff       	call   80103750 <mycpu>
  p = c->proc;
8010448f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104495:	e8 66 05 00 00       	call   80104a00 <popcli>
  uint oldMask = myproc()->signalMask;
8010449a:	8b 9b 84 00 00 00    	mov    0x84(%ebx),%ebx
  pushcli();
801044a0:	e8 1b 05 00 00       	call   801049c0 <pushcli>
  c = mycpu();
801044a5:	e8 a6 f2 ff ff       	call   80103750 <mycpu>
  p = c->proc;
801044aa:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801044b0:	e8 4b 05 00 00       	call   80104a00 <popcli>
  myproc()->signalMask = sigmask;
801044b5:	8b 45 08             	mov    0x8(%ebp),%eax
801044b8:	89 86 84 00 00 00    	mov    %eax,0x84(%esi)
  return oldMask;
}
801044be:	89 d8                	mov    %ebx,%eax
801044c0:	5b                   	pop    %ebx
801044c1:	5e                   	pop    %esi
801044c2:	5d                   	pop    %ebp
801044c3:	c3                   	ret    
...
801044d9:	8b 5d 10             	mov    0x10(%ebp),%ebx
801044dc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801044df:	e8 dc 04 00 00       	call   801049c0 <pushcli>
  c = mycpu();
801044e4:	e8 67 f2 ff ff       	call   80103750 <mycpu>
  p = c->proc;
801044e9:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
801044ef:	e8 0c 05 00 00       	call   80104a00 <popcli>
  struct proc *p;
  p=myproc();
  if(oldact!=null){ // TODO change to NULL
801044f4:	85 db                	test   %ebx,%ebx
801044f6:	74 17                	je     8010450f <sigaction+0x3f>
801044f8:	8b 45 08             	mov    0x8(%ebp),%eax
801044fb:	8d 14 87             	lea    (%edi,%eax,4),%edx
    oldact->sa_handler = p->signalHandler[signum];
801044fe:	8b 8a 0c 01 00 00    	mov    0x10c(%edx),%ecx
80104504:	89 0b                	mov    %ecx,(%ebx)
    oldact->sigmask = p->signalHandlerMasks[signum];
80104506:	8b 92 8c 00 00 00    	mov    0x8c(%edx),%edx
8010450c:	89 53 04             	mov    %edx,0x4(%ebx)
8010450f:	8b 45 08             	mov    0x8(%ebp),%eax
  } 

  p->signalHandler[signum] = act->sa_handler;
80104512:	8b 16                	mov    (%esi),%edx
80104514:	8d 04 87             	lea    (%edi,%eax,4),%eax
80104517:	89 90 0c 01 00 00    	mov    %edx,0x10c(%eax)
  p->signalHandlerMasks[signum] = act->sigmask;
8010451d:	8b 56 04             	mov    0x4(%esi),%edx
80104520:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
...
80104534:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104537:	e8 84 04 00 00       	call   801049c0 <pushcli>
  c = mycpu();
8010453c:	e8 0f f2 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80104541:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104547:	e8 b4 04 00 00       	call   80104a00 <popcli>
  myproc()->killed = 1;
8010454c:	c7 43 24 01 00 00 00 	movl   $0x1,0x24(%ebx)
}
80104553:	83 c4 04             	add    $0x4,%esp
80104556:	5b                   	pop    %ebx
80104557:	5d                   	pop    %ebp
80104558:	c3                   	ret    
...
80104564:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104567:	e8 54 04 00 00       	call   801049c0 <pushcli>
  c = mycpu();
8010456c:	e8 df f1 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80104571:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104577:	e8 84 04 00 00       	call   80104a00 <popcli>
  myproc()->frozen = 1;
8010457c:	c7 43 28 01 00 00 00 	movl   $0x1,0x28(%ebx)
  yield();
}
80104583:	83 c4 04             	add    $0x4,%esp
80104586:	5b                   	pop    %ebx
80104587:	5d                   	pop    %ebp
  yield();
80104588:	e9 f3 f9 ff ff       	jmp    80103f80 <yield>
...
80104594:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104597:	e8 24 04 00 00       	call   801049c0 <pushcli>
  c = mycpu();
8010459c:	e8 af f1 ff ff       	call   80103750 <mycpu>
  p = c->proc;
801045a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801045a7:	e8 54 04 00 00       	call   80104a00 <popcli>
  myproc()->frozen = 0;
801045ac:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
}
801045b3:	83 c4 04             	add    $0x4,%esp
801045b6:	5b                   	pop    %ebx
801045b7:	5d                   	pop    %ebp
801045b8:	c3                   	ret    
...
801045c4:	53                   	push   %ebx
  pushcli();
801045c5:	e8 f6 03 00 00       	call   801049c0 <pushcli>
  c = mycpu();
801045ca:	e8 81 f1 ff ff       	call   80103750 <mycpu>
  p = c->proc;
801045cf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801045d5:	e8 26 04 00 00       	call   80104a00 <popcli>
  pushcli();
801045da:	e8 e1 03 00 00       	call   801049c0 <pushcli>
  c = mycpu();
801045df:	e8 6c f1 ff ff       	call   80103750 <mycpu>
  p = c->proc;
801045e4:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801045ea:	e8 11 04 00 00       	call   80104a00 <popcli>
  myproc()->signalMask=myproc()->signalMaskBU;
801045ef:	8b 86 88 00 00 00    	mov    0x88(%esi),%eax
801045f5:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
  pushcli();
801045fb:	e8 c0 03 00 00       	call   801049c0 <pushcli>
  c = mycpu();
80104600:	e8 4b f1 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80104605:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010460b:	e8 f0 03 00 00       	call   80104a00 <popcli>
  //memmove(&myproc()->signalMask, &myproc()->signalMaskBU, 4);
  memmove(myproc()->tf, myproc()->uTrapFrameBU, sizeof(struct trapframe));
80104610:	8b b3 8c 01 00 00    	mov    0x18c(%ebx),%esi
  pushcli();
80104616:	e8 a5 03 00 00       	call   801049c0 <pushcli>
  c = mycpu();
8010461b:	e8 30 f1 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80104620:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104626:	e8 d5 03 00 00       	call   80104a00 <popcli>
  memmove(myproc()->tf, myproc()->uTrapFrameBU, sizeof(struct trapframe));
8010462b:	83 ec 04             	sub    $0x4,%esp
8010462e:	6a 4c                	push   $0x4c
80104630:	56                   	push   %esi
80104631:	ff 73 18             	pushl  0x18(%ebx)
80104634:	e8 17 06 00 00       	call   80104c50 <memmove>
}
80104639:	83 c4 10             	add    $0x10,%esp
8010463c:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010463f:	5b                   	pop    %ebx
80104640:	5e                   	pop    %esi
80104641:	5d                   	pop    %ebp
80104642:	c3                   	ret    
...
80104656:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80104659:	e8 62 03 00 00       	call   801049c0 <pushcli>
  c = mycpu();
8010465e:	e8 ed f0 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80104663:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104669:	e8 92 03 00 00       	call   80104a00 <popcli>
    struct proc* p = myproc();
    
    if(p == 0){
8010466e:	85 f6                	test   %esi,%esi
80104670:	74 10                	je     80104682 <handle_signals+0x32>
      return;
    }
    if((tf->cs &3) != DPL_USER)
80104672:	8b 45 08             	mov    0x8(%ebp),%eax
80104675:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80104679:	83 e0 03             	and    $0x3,%eax
8010467c:	66 83 f8 03          	cmp    $0x3,%ax
80104680:	74 0e                	je     80104690 <handle_signals+0x40>
          return;

        }
      }
    }
80104682:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104685:	5b                   	pop    %ebx
80104686:	5e                   	pop    %esi
80104687:	5f                   	pop    %edi
80104688:	5d                   	pop    %ebp
...
8010468a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p->killed){
80104690:	8b 5e 24             	mov    0x24(%esi),%ebx
80104693:	85 db                	test   %ebx,%ebx
80104695:	75 eb                	jne    80104682 <handle_signals+0x32>
    for(int i = 0 ; (p->pendingSignals != 0) && i < 32 ; i++){   
80104697:	8b 86 80 00 00 00    	mov    0x80(%esi),%eax
8010469d:	85 c0                	test   %eax,%eax
8010469f:	75 67                	jne    80104708 <handle_signals+0xb8>
801046a1:	eb df                	jmp    80104682 <handle_signals+0x32>
801046a3:	90                   	nop
801046a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        p->pendingSignals &= ~(1 << i);
801046a8:	f7 d2                	not    %edx
801046aa:	21 c2                	and    %eax,%edx
        if(p->signalHandler[i] == (void*)SIGSTOP || i == SIGSTOP){
801046ac:	83 ff 11             	cmp    $0x11,%edi
        p->pendingSignals &= ~(1 << i);
801046af:	89 96 80 00 00 00    	mov    %edx,0x80(%esi)
        if(p->signalHandler[i] == (void*)SIGSTOP || i == SIGSTOP){
801046b5:	0f 84 45 01 00 00    	je     80104800 <handle_signals+0x1b0>
801046bb:	83 fb 11             	cmp    $0x11,%ebx
801046be:	0f 84 3c 01 00 00    	je     80104800 <handle_signals+0x1b0>
        }else if(p->signalHandler[i] == (void*)SIGCONT || (i == SIGCONT && p->signalHandler[i] == (void*)SIG_DFL)){
801046c4:	83 ff 13             	cmp    $0x13,%edi
801046c7:	0f 84 43 01 00 00    	je     80104810 <handle_signals+0x1c0>
801046cd:	85 ff                	test   %edi,%edi
801046cf:	0f 94 c0             	sete   %al
801046d2:	83 fb 13             	cmp    $0x13,%ebx
801046d5:	75 08                	jne    801046df <handle_signals+0x8f>
801046d7:	84 c0                	test   %al,%al
801046d9:	0f 85 31 01 00 00    	jne    80104810 <handle_signals+0x1c0>
        }else if(p->signalHandler[i] == (void*)SIGKILL || p->signalHandler[i] == (void*)SIG_DFL){
801046df:	83 ff 09             	cmp    $0x9,%edi
801046e2:	74 04                	je     801046e8 <handle_signals+0x98>
801046e4:	84 c0                	test   %al,%al
801046e6:	74 77                	je     8010475f <handle_signals+0x10f>
          sh_sigkill();
801046e8:	e8 43 fe ff ff       	call   80104530 <sh_sigkill>
801046ed:	8b 86 80 00 00 00    	mov    0x80(%esi),%eax
801046f3:	90                   	nop
801046f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for(int i = 0 ; (p->pendingSignals != 0) && i < 32 ; i++){   
801046f8:	83 c3 01             	add    $0x1,%ebx
801046fb:	85 c0                	test   %eax,%eax
801046fd:	74 83                	je     80104682 <handle_signals+0x32>
801046ff:	83 fb 20             	cmp    $0x20,%ebx
80104702:	0f 84 7a ff ff ff    	je     80104682 <handle_signals+0x32>
      if((p->pendingSignals & (1 << i)) != 0){
80104708:	ba 01 00 00 00       	mov    $0x1,%edx
8010470d:	89 d9                	mov    %ebx,%ecx
8010470f:	d3 e2                	shl    %cl,%edx
80104711:	85 c2                	test   %eax,%edx
80104713:	74 e3                	je     801046f8 <handle_signals+0xa8>
        if(((p->signalMask & (1 << i)) != 0) && unblockable){
80104715:	8b be 84 00 00 00    	mov    0x84(%esi),%edi
      int unblockable = (i != SIGKILL) && (i != SIGSTOP);
8010471b:	8d 4b f7             	lea    -0x9(%ebx),%ecx
8010471e:	83 e1 f7             	and    $0xfffffff7,%ecx
        if(((p->signalMask & (1 << i)) != 0) && unblockable){
80104721:	85 d7                	test   %edx,%edi
80104723:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80104726:	74 04                	je     8010472c <handle_signals+0xdc>
80104728:	85 c9                	test   %ecx,%ecx
8010472a:	75 cc                	jne    801046f8 <handle_signals+0xa8>
      uint espbu = p->tf->esp;
8010472c:	8b 7e 18             	mov    0x18(%esi),%edi
8010472f:	89 7d e0             	mov    %edi,-0x20(%ebp)
80104732:	8b 7f 44             	mov    0x44(%edi),%edi
80104735:	89 7d dc             	mov    %edi,-0x24(%ebp)
        if(p->signalHandler[i]==(void*)SIG_IGN && unblockable){
80104738:	8b bc 9e 0c 01 00 00 	mov    0x10c(%esi,%ebx,4),%edi
8010473f:	83 ff 01             	cmp    $0x1,%edi
80104742:	0f 85 60 ff ff ff    	jne    801046a8 <handle_signals+0x58>
80104748:	85 c9                	test   %ecx,%ecx
8010474a:	75 ac                	jne    801046f8 <handle_signals+0xa8>
        p->pendingSignals &= ~(1 << i);
8010474c:	f7 d2                	not    %edx
8010474e:	21 c2                	and    %eax,%edx
        if(p->signalHandler[i] == (void*)SIGSTOP || i == SIGSTOP){
80104750:	83 fb 11             	cmp    $0x11,%ebx
        p->pendingSignals &= ~(1 << i);
80104753:	89 96 80 00 00 00    	mov    %edx,0x80(%esi)
        if(p->signalHandler[i] == (void*)SIGSTOP || i == SIGSTOP){
80104759:	0f 84 a1 00 00 00    	je     80104800 <handle_signals+0x1b0>
          p->signalMaskBU=p->signalMask;
8010475f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104762:	8d 3c 9e             	lea    (%esi,%ebx,4),%edi
          memmove(p->uTrapFrameBU, p->tf, sizeof(struct trapframe));
80104765:	83 ec 04             	sub    $0x4,%esp
          p->signalMaskBU=p->signalMask;
80104768:	89 86 88 00 00 00    	mov    %eax,0x88(%esi)
          p->signalMask = p->signalHandlerMasks[i];
8010476e:	8b 87 8c 00 00 00    	mov    0x8c(%edi),%eax
80104774:	89 86 84 00 00 00    	mov    %eax,0x84(%esi)
          p->tf->esp -= sizeof (struct trapframe);
8010477a:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010477d:	83 68 44 4c          	subl   $0x4c,0x44(%eax)
          p->uTrapFrameBU = (void*) (p->tf->esp);
80104781:	8b 56 18             	mov    0x18(%esi),%edx
80104784:	8b 42 44             	mov    0x44(%edx),%eax
80104787:	89 86 8c 01 00 00    	mov    %eax,0x18c(%esi)
          memmove(p->uTrapFrameBU, p->tf, sizeof(struct trapframe));
8010478d:	6a 4c                	push   $0x4c
8010478f:	52                   	push   %edx
80104790:	50                   	push   %eax
80104791:	e8 ba 04 00 00       	call   80104c50 <memmove>
          p->uTrapFrameBU->esp=espbu;
80104796:	8b 86 8c 01 00 00    	mov    0x18c(%esi),%eax
8010479c:	8b 4d dc             	mov    -0x24(%ebp),%ecx
          memmove((void*)p->tf->esp,sigret_start, (uint)&sigret_end - (uint)&sigret_start);
8010479f:	83 c4 0c             	add    $0xc,%esp
          p->uTrapFrameBU->esp=espbu;
801047a2:	89 48 44             	mov    %ecx,0x44(%eax)
          p->tf->esp -= (uint)&sigret_end - (uint)&sigret_start;
801047a5:	8b 56 18             	mov    0x18(%esi),%edx
801047a8:	b8 4e 22 10 80       	mov    $0x8010224e,%eax
801047ad:	2d 55 22 10 80       	sub    $0x80102255,%eax
801047b2:	01 42 44             	add    %eax,0x44(%edx)
          memmove((void*)p->tf->esp,sigret_start, (uint)&sigret_end - (uint)&sigret_start);
801047b5:	b8 55 22 10 80       	mov    $0x80102255,%eax
801047ba:	2d 4e 22 10 80       	sub    $0x8010224e,%eax
801047bf:	50                   	push   %eax
801047c0:	68 4e 22 10 80       	push   $0x8010224e
801047c5:	8b 46 18             	mov    0x18(%esi),%eax
801047c8:	ff 70 44             	pushl  0x44(%eax)
801047cb:	e8 80 04 00 00       	call   80104c50 <memmove>
          *((int*)(p->tf->esp-4)) = i;
801047d0:	8b 46 18             	mov    0x18(%esi),%eax
          return;
801047d3:	83 c4 10             	add    $0x10,%esp
          *((int*)(p->tf->esp-4)) = i;
801047d6:	8b 40 44             	mov    0x44(%eax),%eax
801047d9:	89 58 fc             	mov    %ebx,-0x4(%eax)
          *((int*)(p->tf->esp-8)) = p->tf->esp;
801047dc:	8b 46 18             	mov    0x18(%esi),%eax
801047df:	8b 40 44             	mov    0x44(%eax),%eax
801047e2:	89 40 f8             	mov    %eax,-0x8(%eax)
          p->tf->esp -= 8;
801047e5:	8b 46 18             	mov    0x18(%esi),%eax
801047e8:	83 68 44 08          	subl   $0x8,0x44(%eax)
          p->tf->eip = (uint)p->signalHandler[i];
801047ec:	8b 46 18             	mov    0x18(%esi),%eax
801047ef:	8b 97 0c 01 00 00    	mov    0x10c(%edi),%edx
801047f5:	89 50 38             	mov    %edx,0x38(%eax)
          return;
801047f8:	e9 85 fe ff ff       	jmp    80104682 <handle_signals+0x32>
801047fd:	8d 76 00             	lea    0x0(%esi),%esi
          sh_sigstop();
80104800:	e8 5b fd ff ff       	call   80104560 <sh_sigstop>
80104805:	8b 86 80 00 00 00    	mov    0x80(%esi),%eax
8010480b:	e9 e8 fe ff ff       	jmp    801046f8 <handle_signals+0xa8>
          sh_sigcont();
80104810:	e8 7b fd ff ff       	call   80104590 <sh_sigcont>
80104815:	8b 86 80 00 00 00    	mov    0x80(%esi),%eax
8010481b:	e9 d8 fe ff ff       	jmp    801046f8 <handle_signals+0xa8>
...
8010482a:	68 34 7e 10 80       	push   $0x80107e34
...
8010486f:	e8 1c 02 00 00       	call   80104a90 <acquire>
  while (lk->locked) {
...
80104885:	e8 56 f7 ff ff       	call   80103fe0 <sleep>
  while (lk->locked) {
...
80104893:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104899:	e8 52 ef ff ff       	call   801037f0 <myproc>
...
801048ac:	5d                   	pop    %ebp
  release(&lk->lk);
801048ad:	e9 9e 02 00 00       	jmp    80104b50 <release>
...
801048cf:	e8 bc 01 00 00       	call   80104a90 <acquire>
  lk->locked = 0;
...
801048e4:	e8 97 f9 ff ff       	call   80104280 <wakeup>
  release(&lk->lk);
...
801048f4:	5d                   	pop    %ebp
  release(&lk->lk);
801048f5:	e9 56 02 00 00       	jmp    80104b50 <release>
...
80104912:	e8 79 01 00 00       	call   80104a90 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104917:	8b 03                	mov    (%ebx),%eax
80104919:	83 c4 10             	add    $0x10,%esp
8010491c:	85 c0                	test   %eax,%eax
8010491e:	74 13                	je     80104933 <holdingsleep+0x33>
80104920:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80104923:	e8 c8 ee ff ff       	call   801037f0 <myproc>
...
80104937:	e8 14 02 00 00       	call   80104b50 <release>
  return r;
}
...
801049c9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801049ca:	e8 81 ed ff ff       	call   80103750 <mycpu>
...
801049df:	e8 6c ed ff ff       	call   80103750 <mycpu>
801049e4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801049ea:	e8 61 ed ff ff       	call   80103750 <mycpu>
...
80104a2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104a30:	e8 1b ed ff ff       	call   80103750 <mycpu>
...
80104a45:	68 3f 7e 10 80       	push   $0x80107e3f
80104a4a:	e8 41 b9 ff ff       	call   80100390 <panic>
    panic("popcli");
80104a4f:	83 ec 0c             	sub    $0xc,%esp
80104a52:	68 56 7e 10 80       	push   $0x80107e56
...
80104a68:	31 db                	xor    %ebx,%ebx
  pushcli();
80104a6a:	e8 51 ff ff ff       	call   801049c0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104a6f:	8b 06                	mov    (%esi),%eax
80104a71:	85 c0                	test   %eax,%eax
80104a73:	74 10                	je     80104a85 <holding+0x25>
80104a75:	8b 5e 08             	mov    0x8(%esi),%ebx
80104a78:	e8 d3 ec ff ff       	call   80103750 <mycpu>
80104a7d:	39 c3                	cmp    %eax,%ebx
80104a7f:	0f 94 c3             	sete   %bl
80104a82:	0f b6 db             	movzbl %bl,%ebx
  popcli();
80104a85:	e8 76 ff ff ff       	call   80104a00 <popcli>
}
...
80104a95:	e8 26 ff ff ff       	call   801049c0 <pushcli>
  if(holding(lk))
80104a9a:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104a9d:	83 ec 0c             	sub    $0xc,%esp
80104aa0:	53                   	push   %ebx
80104aa1:	e8 ba ff ff ff       	call   80104a60 <holding>
80104aa6:	83 c4 10             	add    $0x10,%esp
80104aa9:	85 c0                	test   %eax,%eax
80104aab:	0f 85 83 00 00 00    	jne    80104b34 <acquire+0xa4>
80104ab1:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
80104ab3:	ba 01 00 00 00       	mov    $0x1,%edx
80104ab8:	eb 09                	jmp    80104ac3 <acquire+0x33>
...
80104ad4:	e8 77 ec ff ff       	call   80103750 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104ad9:	8d 53 0c             	lea    0xc(%ebx),%edx
  lk->cpu = mycpu();
80104adc:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
80104adf:	89 e8                	mov    %ebp,%eax
80104ae1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104ae8:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
80104aee:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
80104af4:	77 1a                	ja     80104b10 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
80104af6:	8b 48 04             	mov    0x4(%eax),%ecx
80104af9:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
  for(i = 0; i < 10; i++){
80104afc:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
80104aff:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104b01:	83 fe 0a             	cmp    $0xa,%esi
80104b04:	75 e2                	jne    80104ae8 <acquire+0x58>
}
...
80104b10:	8d 04 b2             	lea    (%edx,%esi,4),%eax
80104b13:	83 c2 28             	add    $0x28,%edx
...
80104b2b:	75 f3                	jne    80104b20 <acquire+0x90>
}
...
80104b37:	68 5d 7e 10 80       	push   $0x80107e5d
80104b3c:	e8 4f b8 ff ff       	call   80100390 <panic>
80104b41:	eb 0d                	jmp    80104b50 <release>
80104b43:	90                   	nop
80104b44:	90                   	nop
80104b45:	90                   	nop
80104b46:	90                   	nop
...
80104b5b:	e8 00 ff ff ff       	call   80104a60 <holding>
80104b60:	83 c4 10             	add    $0x10,%esp
80104b63:	85 c0                	test   %eax,%eax
80104b65:	74 22                	je     80104b89 <release+0x39>
  lk->pcs[0] = 0;
80104b67:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104b6e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104b75:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104b7a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80104b80:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104b83:	c9                   	leave  
  popcli();
80104b84:	e9 77 fe ff ff       	jmp    80104a00 <popcli>
    panic("release");
80104b89:	83 ec 0c             	sub    $0xc,%esp
80104b8c:	68 65 7e 10 80       	push   $0x80107e65
80104b91:	e8 fa b7 ff ff       	call   80100390 <panic>
...
80104ba8:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
80104bab:	f6 c2 03             	test   $0x3,%dl
80104bae:	75 05                	jne    80104bb5 <memset+0x15>
80104bb0:	f6 c1 03             	test   $0x3,%cl
80104bb3:	74 13                	je     80104bc8 <memset+0x28>
  asm volatile("cld; rep stosb" :
80104bb5:	89 d7                	mov    %edx,%edi
80104bb7:	8b 45 0c             	mov    0xc(%ebp),%eax
80104bba:	fc                   	cld    
80104bbb:	f3 aa                	rep stos %al,%es:(%edi)
    c &= 0xFF;
...
80104bc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    c &= 0xFF;
80104bc8:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104bcc:	c1 e9 02             	shr    $0x2,%ecx
80104bcf:	89 f8                	mov    %edi,%eax
80104bd1:	89 fb                	mov    %edi,%ebx
80104bd3:	c1 e0 18             	shl    $0x18,%eax
...
80104bfc:	8b 7d 0c             	mov    0xc(%ebp),%edi
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
80104bff:	85 db                	test   %ebx,%ebx
80104c01:	74 29                	je     80104c2c <memcmp+0x3c>
    if(*s1 != *s2)
80104c03:	0f b6 16             	movzbl (%esi),%edx
80104c06:	0f b6 0f             	movzbl (%edi),%ecx
80104c09:	38 d1                	cmp    %dl,%cl
80104c0b:	75 2b                	jne    80104c38 <memcmp+0x48>
80104c0d:	b8 01 00 00 00       	mov    $0x1,%eax
80104c12:	eb 14                	jmp    80104c28 <memcmp+0x38>
80104c14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104c18:	0f b6 14 06          	movzbl (%esi,%eax,1),%edx
80104c1c:	83 c0 01             	add    $0x1,%eax
80104c1f:	0f b6 4c 07 ff       	movzbl -0x1(%edi,%eax,1),%ecx
80104c24:	38 ca                	cmp    %cl,%dl
80104c26:	75 10                	jne    80104c38 <memcmp+0x48>
  while(n-- > 0){
80104c28:	39 d8                	cmp    %ebx,%eax
80104c2a:	75 ec                	jne    80104c18 <memcmp+0x28>
      return *s1 - *s2;
    s1++, s2++;
  }
...
80104c5b:	8b 75 10             	mov    0x10(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104c5e:	39 c3                	cmp    %eax,%ebx
80104c60:	73 26                	jae    80104c88 <memmove+0x38>
80104c62:	8d 0c 33             	lea    (%ebx,%esi,1),%ecx
80104c65:	39 c8                	cmp    %ecx,%eax
80104c67:	73 1f                	jae    80104c88 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
80104c69:	85 f6                	test   %esi,%esi
80104c6b:	8d 56 ff             	lea    -0x1(%esi),%edx
80104c6e:	74 0f                	je     80104c7f <memmove+0x2f>
      *--d = *--s;
80104c70:	0f b6 0c 13          	movzbl (%ebx,%edx,1),%ecx
80104c74:	88 0c 10             	mov    %cl,(%eax,%edx,1)
    while(n-- > 0)
80104c77:	83 ea 01             	sub    $0x1,%edx
80104c7a:	83 fa ff             	cmp    $0xffffffff,%edx
80104c7d:	75 f1                	jne    80104c70 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
80104c84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    while(n-- > 0)
80104c88:	31 d2                	xor    %edx,%edx
80104c8a:	85 f6                	test   %esi,%esi
80104c8c:	74 f1                	je     80104c7f <memmove+0x2f>
80104c8e:	66 90                	xchg   %ax,%ax
      *d++ = *s++;
80104c90:	0f b6 0c 13          	movzbl (%ebx,%edx,1),%ecx
80104c94:	88 0c 10             	mov    %cl,(%eax,%edx,1)
80104c97:	83 c2 01             	add    $0x1,%edx
    while(n-- > 0)
80104c9a:	39 d6                	cmp    %edx,%esi
80104c9c:	75 f2                	jne    80104c90 <memmove+0x40>
}
80104c9e:	5b                   	pop    %ebx
80104c9f:	5e                   	pop    %esi
80104ca0:	5d                   	pop    %ebp
...
80104cc5:	8b 7d 10             	mov    0x10(%ebp),%edi
80104cc8:	53                   	push   %ebx
80104cc9:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104ccc:	8b 75 0c             	mov    0xc(%ebp),%esi
  while(n > 0 && *p && *p == *q)
80104ccf:	85 ff                	test   %edi,%edi
80104cd1:	74 2f                	je     80104d02 <strncmp+0x42>
80104cd3:	0f b6 01             	movzbl (%ecx),%eax
80104cd6:	0f b6 1e             	movzbl (%esi),%ebx
80104cd9:	84 c0                	test   %al,%al
80104cdb:	74 37                	je     80104d14 <strncmp+0x54>
80104cdd:	38 c3                	cmp    %al,%bl
80104cdf:	75 33                	jne    80104d14 <strncmp+0x54>
80104ce1:	01 f7                	add    %esi,%edi
80104ce3:	eb 13                	jmp    80104cf8 <strncmp+0x38>
80104ce5:	8d 76 00             	lea    0x0(%esi),%esi
80104ce8:	0f b6 01             	movzbl (%ecx),%eax
80104ceb:	84 c0                	test   %al,%al
80104ced:	74 21                	je     80104d10 <strncmp+0x50>
80104cef:	0f b6 1a             	movzbl (%edx),%ebx
80104cf2:	89 d6                	mov    %edx,%esi
80104cf4:	38 d8                	cmp    %bl,%al
80104cf6:	75 1c                	jne    80104d14 <strncmp+0x54>
    n--, p++, q++;
80104cf8:	8d 56 01             	lea    0x1(%esi),%edx
80104cfb:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104cfe:	39 fa                	cmp    %edi,%edx
80104d00:	75 e6                	jne    80104ce8 <strncmp+0x28>
  if(n == 0)
    return 0;
...
80104d10:	0f b6 5e 01          	movzbl 0x1(%esi),%ebx
  return (uchar)*p - (uchar)*q;
...
80104d30:	eb 19                	jmp    80104d4b <strncpy+0x2b>
80104d32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104d38:	83 c3 01             	add    $0x1,%ebx
80104d3b:	0f b6 4b ff          	movzbl -0x1(%ebx),%ecx
80104d3f:	83 c2 01             	add    $0x1,%edx
80104d42:	84 c9                	test   %cl,%cl
80104d44:	88 4a ff             	mov    %cl,-0x1(%edx)
80104d47:	74 09                	je     80104d52 <strncpy+0x32>
80104d49:	89 f1                	mov    %esi,%ecx
80104d4b:	85 c9                	test   %ecx,%ecx
80104d4d:	8d 71 ff             	lea    -0x1(%ecx),%esi
80104d50:	7f e6                	jg     80104d38 <strncpy+0x18>
    ;
  while(n-- > 0)
80104d52:	31 c9                	xor    %ecx,%ecx
80104d54:	85 f6                	test   %esi,%esi
80104d56:	7e 17                	jle    80104d6f <strncpy+0x4f>
80104d58:	90                   	nop
80104d59:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
80104d60:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
80104d64:	89 f3                	mov    %esi,%ebx
80104d66:	83 c1 01             	add    $0x1,%ecx
80104d69:	29 cb                	sub    %ecx,%ebx
  while(n-- > 0)
80104d6b:	85 db                	test   %ebx,%ebx
80104d6d:	7f f1                	jg     80104d60 <strncpy+0x40>
  return os;
}
80104d6f:	5b                   	pop    %ebx
80104d70:	5e                   	pop    %esi
80104d71:	5d                   	pop    %ebp
80104d72:	c3                   	ret    
80104d73:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80104d85:	8b 4d 10             	mov    0x10(%ebp),%ecx
...
80104d8b:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  os = s;
  if(n <= 0)
80104d8e:	85 c9                	test   %ecx,%ecx
80104d90:	7e 26                	jle    80104db8 <safestrcpy+0x38>
80104d92:	8d 74 0a ff          	lea    -0x1(%edx,%ecx,1),%esi
80104d96:	89 c1                	mov    %eax,%ecx
80104d98:	eb 17                	jmp    80104db1 <safestrcpy+0x31>
80104d9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80104da0:	83 c2 01             	add    $0x1,%edx
80104da3:	0f b6 5a ff          	movzbl -0x1(%edx),%ebx
80104da7:	83 c1 01             	add    $0x1,%ecx
80104daa:	84 db                	test   %bl,%bl
80104dac:	88 59 ff             	mov    %bl,-0x1(%ecx)
80104daf:	74 04                	je     80104db5 <safestrcpy+0x35>
80104db1:	39 f2                	cmp    %esi,%edx
80104db3:	75 eb                	jne    80104da0 <safestrcpy+0x20>
    ;
  *s = 0;
80104db5:	c6 01 00             	movb   $0x0,(%ecx)
  return os;
}
80104db8:	5b                   	pop    %ebx
80104db9:	5e                   	pop    %esi
...
80104e37:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104e3a:	e8 b1 e9 ff ff       	call   801037f0 <myproc>

  if(addr >= curproc->sz)
80104e3f:	39 18                	cmp    %ebx,(%eax)
80104e41:	76 29                	jbe    80104e6c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104e43:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104e46:	89 da                	mov    %ebx,%edx
80104e48:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
80104e4a:	8b 00                	mov    (%eax),%eax
  for(s = *pp; s < ep; s++){
80104e4c:	39 c3                	cmp    %eax,%ebx
80104e4e:	73 1c                	jae    80104e6c <fetchstr+0x3c>
    if(*s == 0)
80104e50:	80 3b 00             	cmpb   $0x0,(%ebx)
80104e53:	75 10                	jne    80104e65 <fetchstr+0x35>
80104e55:	eb 39                	jmp    80104e90 <fetchstr+0x60>
80104e57:	89 f6                	mov    %esi,%esi
80104e59:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80104e60:	80 3a 00             	cmpb   $0x0,(%edx)
80104e63:	74 1b                	je     80104e80 <fetchstr+0x50>
  for(s = *pp; s < ep; s++){
80104e65:	83 c2 01             	add    $0x1,%edx
80104e68:	39 d0                	cmp    %edx,%eax
80104e6a:	77 f4                	ja     80104e60 <fetchstr+0x30>
    return -1;
...
80104e90:	31 c0                	xor    %eax,%eax
      return s - *pp;
80104e92:	eb dd                	jmp    80104e71 <fetchstr+0x41>
...
80104ea5:	e8 46 e9 ff ff       	call   801037f0 <myproc>
80104eaa:	8b 40 18             	mov    0x18(%eax),%eax
80104ead:	8b 55 08             	mov    0x8(%ebp),%edx
80104eb0:	8b 40 44             	mov    0x44(%eax),%eax
80104eb3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104eb6:	e8 35 e9 ff ff       	call   801037f0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104ebb:	8b 00                	mov    (%eax),%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ebd:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104ef8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104efb:	e8 f0 e8 ff ff       	call   801037f0 <myproc>
...
80104f0c:	e8 8f ff ff ff       	call   80104ea0 <argint>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104f11:	83 c4 10             	add    $0x10,%esp
80104f14:	85 c0                	test   %eax,%eax
80104f16:	78 28                	js     80104f40 <argptr+0x50>
80104f18:	85 db                	test   %ebx,%ebx
80104f1a:	78 24                	js     80104f40 <argptr+0x50>
80104f1c:	8b 16                	mov    (%esi),%edx
80104f1e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f21:	39 c2                	cmp    %eax,%edx
80104f23:	76 1b                	jbe    80104f40 <argptr+0x50>
80104f25:	01 c3                	add    %eax,%ebx
80104f27:	39 da                	cmp    %ebx,%edx
80104f29:	72 15                	jb     80104f40 <argptr+0x50>
    return -1;
  *pp = (char*)i;
80104f2b:	8b 55 0c             	mov    0xc(%ebp),%edx
80104f2e:	89 02                	mov    %eax,(%edx)
  return 0;
...
80104f45:	eb eb                	jmp    80104f32 <argptr+0x42>
...
80104f94:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104f97:	e8 54 e8 ff ff       	call   801037f0 <myproc>
...
80104faa:	77 1c                	ja     80104fc8 <syscall+0x38>
80104fac:	8b 14 85 a0 7e 10 80 	mov    -0x7fef8160(,%eax,4),%edx
80104fb3:	85 d2                	test   %edx,%edx
80104fb5:	74 11                	je     80104fc8 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104fb7:	ff d2                	call   *%edx
80104fb9:	8b 53 18             	mov    0x18(%ebx),%edx
80104fbc:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
80104fc8:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104fc9:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104fcc:	50                   	push   %eax
80104fcd:	ff 73 10             	pushl  0x10(%ebx)
80104fd0:	68 6d 7e 10 80       	push   $0x80107e6d
80104fd5:	e8 86 b6 ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
80104fda:	8b 43 18             	mov    0x18(%ebx),%eax
80104fdd:	83 c4 10             	add    $0x10,%esp
80104fe0:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104ff6:	8d 75 da             	lea    -0x26(%ebp),%esi
{
...
{
80105004:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80105007:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010500a:	e8 21 cf ff ff       	call   80101f30 <nameiparent>
8010500f:	83 c4 10             	add    $0x10,%esp
80105012:	85 c0                	test   %eax,%eax
80105014:	0f 84 46 01 00 00    	je     80105160 <create+0x170>
    return 0;
  ilock(dp);
8010501a:	83 ec 0c             	sub    $0xc,%esp
8010501d:	89 c3                	mov    %eax,%ebx
8010501f:	50                   	push   %eax
80105020:	e8 8b c6 ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80105025:	83 c4 0c             	add    $0xc,%esp
80105028:	6a 00                	push   $0x0
8010502a:	56                   	push   %esi
8010502b:	53                   	push   %ebx
8010502c:	e8 af cb ff ff       	call   80101be0 <dirlookup>
80105031:	83 c4 10             	add    $0x10,%esp
80105034:	85 c0                	test   %eax,%eax
80105036:	89 c7                	mov    %eax,%edi
80105038:	74 36                	je     80105070 <create+0x80>
    iunlockput(dp);
8010503a:	83 ec 0c             	sub    $0xc,%esp
8010503d:	53                   	push   %ebx
8010503e:	e8 fd c8 ff ff       	call   80101940 <iunlockput>
    ilock(ip);
80105043:	89 3c 24             	mov    %edi,(%esp)
80105046:	e8 65 c6 ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010504b:	83 c4 10             	add    $0x10,%esp
8010504e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105053:	0f 85 97 00 00 00    	jne    801050f0 <create+0x100>
80105059:	66 83 7f 50 02       	cmpw   $0x2,0x50(%edi)
8010505e:	0f 85 8c 00 00 00    	jne    801050f0 <create+0x100>
...
80105078:	ff 33                	pushl  (%ebx)
8010507a:	e8 c1 c4 ff ff       	call   80101540 <ialloc>
8010507f:	83 c4 10             	add    $0x10,%esp
80105082:	85 c0                	test   %eax,%eax
80105084:	89 c7                	mov    %eax,%edi
80105086:	0f 84 e8 00 00 00    	je     80105174 <create+0x184>
  ilock(ip);
...
80105099:	66 89 47 52          	mov    %ax,0x52(%edi)
  ip->minor = minor;
8010509d:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
801050a1:	66 89 47 54          	mov    %ax,0x54(%edi)
  ip->nlink = 1;
801050a5:	b8 01 00 00 00       	mov    $0x1,%eax
801050aa:	66 89 47 56          	mov    %ax,0x56(%edi)
  iupdate(ip);
801050ae:	89 3c 24             	mov    %edi,(%esp)
801050b1:	e8 4a c5 ff ff       	call   80101600 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
801050b6:	83 c4 10             	add    $0x10,%esp
801050b9:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801050be:	74 50                	je     80105110 <create+0x120>
  if(dirlink(dp, name, ip->inum) < 0)
801050c0:	83 ec 04             	sub    $0x4,%esp
801050c3:	ff 77 04             	pushl  0x4(%edi)
801050c6:	56                   	push   %esi
801050c7:	53                   	push   %ebx
801050c8:	e8 83 cd ff ff       	call   80101e50 <dirlink>
801050cd:	83 c4 10             	add    $0x10,%esp
801050d0:	85 c0                	test   %eax,%eax
801050d2:	0f 88 8f 00 00 00    	js     80105167 <create+0x177>
  iunlockput(dp);
801050d8:	83 ec 0c             	sub    $0xc,%esp
801050db:	53                   	push   %ebx
801050dc:	e8 5f c8 ff ff       	call   80101940 <iunlockput>
  return ip;
...
801050f3:	57                   	push   %edi
    return 0;
801050f4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
801050f6:	e8 45 c8 ff ff       	call   80101940 <iunlockput>
    return 0;
801050fb:	83 c4 10             	add    $0x10,%esp
}
801050fe:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105101:	89 f8                	mov    %edi,%eax
80105103:	5b                   	pop    %ebx
80105104:	5e                   	pop    %esi
80105105:	5f                   	pop    %edi
80105106:	5d                   	pop    %ebp
...
80105109:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink++;  // for ".."
80105110:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    iupdate(dp);
...
80105121:	ff 77 04             	pushl  0x4(%edi)
80105124:	68 20 7f 10 80       	push   $0x80107f20
80105129:	57                   	push   %edi
8010512a:	e8 21 cd ff ff       	call   80101e50 <dirlink>
8010512f:	83 c4 10             	add    $0x10,%esp
80105132:	85 c0                	test   %eax,%eax
80105134:	78 1c                	js     80105152 <create+0x162>
80105136:	83 ec 04             	sub    $0x4,%esp
80105139:	ff 73 04             	pushl  0x4(%ebx)
8010513c:	68 1f 7f 10 80       	push   $0x80107f1f
80105141:	57                   	push   %edi
80105142:	e8 09 cd ff ff       	call   80101e50 <dirlink>
80105147:	83 c4 10             	add    $0x10,%esp
8010514a:	85 c0                	test   %eax,%eax
8010514c:	0f 89 6e ff ff ff    	jns    801050c0 <create+0xd0>
      panic("create dots");
80105152:	83 ec 0c             	sub    $0xc,%esp
80105155:	68 13 7f 10 80       	push   $0x80107f13
8010515a:	e8 31 b2 ff ff       	call   80100390 <panic>
8010515f:	90                   	nop
    return 0;
80105160:	31 ff                	xor    %edi,%edi
80105162:	e9 fd fe ff ff       	jmp    80105064 <create+0x74>
    panic("create: dirlink");
80105167:	83 ec 0c             	sub    $0xc,%esp
8010516a:	68 22 7f 10 80       	push   $0x80107f22
8010516f:	e8 1c b2 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80105174:	83 ec 0c             	sub    $0xc,%esp
80105177:	68 04 7f 10 80       	push   $0x80107f04
8010517c:	e8 0f b2 ff ff       	call   80100390 <panic>
80105181:	eb 0d                	jmp    80105190 <argfd.constprop.0>
80105183:	90                   	nop
80105184:	90                   	nop
80105185:	90                   	nop
80105186:	90                   	nop
...
argfd(int n, int *pfd, struct file **pf)
8010519a:	89 d6                	mov    %edx,%esi
8010519c:	83 ec 18             	sub    $0x18,%esp
  if(argint(n, &fd) < 0)
8010519f:	50                   	push   %eax
801051a0:	6a 00                	push   $0x0
801051a2:	e8 f9 fc ff ff       	call   80104ea0 <argint>
801051a7:	83 c4 10             	add    $0x10,%esp
801051aa:	85 c0                	test   %eax,%eax
801051ac:	78 2a                	js     801051d8 <argfd.constprop.0+0x48>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801051ae:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
801051b2:	77 24                	ja     801051d8 <argfd.constprop.0+0x48>
801051b4:	e8 37 e6 ff ff       	call   801037f0 <myproc>
801051b9:	8b 55 f4             	mov    -0xc(%ebp),%edx
801051bc:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
801051c0:	85 c0                	test   %eax,%eax
801051c2:	74 14                	je     801051d8 <argfd.constprop.0+0x48>
  if(pfd)
801051c4:	85 db                	test   %ebx,%ebx
801051c6:	74 02                	je     801051ca <argfd.constprop.0+0x3a>
    *pfd = fd;
801051c8:	89 13                	mov    %edx,(%ebx)
    *pf = f;
801051ca:	89 06                	mov    %eax,(%esi)
  return 0;
...
801051dd:	eb ef                	jmp    801051ce <argfd.constprop.0+0x3e>
801051df:	90                   	nop
...
801051e6:	53                   	push   %ebx
  if(argfd(0, 0, &f) < 0)
801051e7:	8d 55 f4             	lea    -0xc(%ebp),%edx
{
801051ea:	83 ec 10             	sub    $0x10,%esp
  if(argfd(0, 0, &f) < 0)
801051ed:	e8 9e ff ff ff       	call   80105190 <argfd.constprop.0>
801051f2:	85 c0                	test   %eax,%eax
801051f4:	78 42                	js     80105238 <sys_dup+0x58>
  if((fd=fdalloc(f)) < 0)
801051f6:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
801051f9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801051fb:	e8 f0 e5 ff ff       	call   801037f0 <myproc>
80105200:	eb 0e                	jmp    80105210 <sys_dup+0x30>
80105202:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(fd = 0; fd < NOFILE; fd++){
80105208:	83 c3 01             	add    $0x1,%ebx
8010520b:	83 fb 10             	cmp    $0x10,%ebx
8010520e:	74 28                	je     80105238 <sys_dup+0x58>
    if(curproc->ofile[fd] == 0){
80105210:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
80105214:	85 d2                	test   %edx,%edx
80105216:	75 f0                	jne    80105208 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80105218:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
8010521c:	83 ec 0c             	sub    $0xc,%esp
8010521f:	ff 75 f4             	pushl  -0xc(%ebp)
80105222:	e8 f9 bb ff ff       	call   80100e20 <filedup>
  return fd;
80105227:	83 c4 10             	add    $0x10,%esp
}
8010522a:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010522d:	89 d8                	mov    %ebx,%eax
8010522f:	5b                   	pop    %ebx
80105230:	5e                   	pop    %esi
80105231:	5d                   	pop    %ebp
80105232:	c3                   	ret    
...
80105238:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
8010523b:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
80105285:	e8 66 fc ff ff       	call   80104ef0 <argptr>
8010528a:	83 c4 10             	add    $0x10,%esp
8010528d:	85 c0                	test   %eax,%eax
8010528f:	78 1f                	js     801052b0 <sys_read+0x60>
...
8010529d:	e8 ee bc ff ff       	call   80100f90 <fileread>
...
801052f5:	e8 f6 fb ff ff       	call   80104ef0 <argptr>
801052fa:	83 c4 10             	add    $0x10,%esp
801052fd:	85 c0                	test   %eax,%eax
801052ff:	78 1f                	js     80105320 <sys_write+0x60>
...
8010530d:	e8 0e bd ff ff       	call   80101020 <filewrite>
...
8010533c:	e8 4f fe ff ff       	call   80105190 <argfd.constprop.0>
80105341:	85 c0                	test   %eax,%eax
80105343:	78 2b                	js     80105370 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80105345:	e8 a6 e4 ff ff       	call   801037f0 <myproc>
8010534a:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
8010534d:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80105350:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80105357:	00 
  fileclose(f);
80105358:	ff 75 f4             	pushl  -0xc(%ebp)
8010535b:	e8 10 bb ff ff       	call   80100e70 <fileclose>
  return 0;
...
80105448:	e8 b3 c1 ff ff       	call   80101600 <iupdate>
  iunlock(ip);
8010544d:	89 1c 24             	mov    %ebx,(%esp)
80105450:	e8 3b c3 ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105455:	58                   	pop    %eax
80105456:	5a                   	pop    %edx
80105457:	57                   	push   %edi
80105458:	ff 75 d0             	pushl  -0x30(%ebp)
8010545b:	e8 d0 ca ff ff       	call   80101f30 <nameiparent>
...
80105493:	e8 a8 c4 ff ff       	call   80101940 <iunlockput>
  iput(ip);
80105498:	89 1c 24             	mov    %ebx,(%esp)
8010549b:	e8 40 c3 ff ff       	call   801017e0 <iput>
  end_op();
801054a0:	e8 ab d7 ff ff       	call   80102c50 <end_op>
  return 0;
...
801054c8:	e8 e3 c1 ff ff       	call   801016b0 <ilock>
  ip->nlink--;
801054cd:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801054d2:	89 1c 24             	mov    %ebx,(%esp)
801054d5:	e8 26 c1 ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
801054da:	89 1c 24             	mov    %ebx,(%esp)
801054dd:	e8 5e c4 ff ff       	call   80101940 <iunlockput>
  end_op();
801054e2:	e8 69 d7 ff ff       	call   80102c50 <end_op>
  return -1;
...
801054fb:	e8 40 c4 ff ff       	call   80101940 <iunlockput>
    end_op();
80105500:	e8 4b d7 ff ff       	call   80102c50 <end_op>
    return -1;
80105505:	83 c4 10             	add    $0x10,%esp
80105508:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010550d:	eb 9b                	jmp    801054aa <sys_link+0xda>
    end_op();
8010550f:	e8 3c d7 ff ff       	call   80102c50 <end_op>
    return -1;
80105514:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105519:	eb 8f                	jmp    801054aa <sys_link+0xda>
8010551b:	90                   	nop
...
8010552f:	e8 1c fa ff ff       	call   80104f50 <argstr>
80105534:	83 c4 10             	add    $0x10,%esp
80105537:	85 c0                	test   %eax,%eax
80105539:	0f 88 77 01 00 00    	js     801056b6 <sys_unlink+0x196>
  if((dp = nameiparent(path, name)) == 0){
8010553f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80105542:	e8 99 d6 ff ff       	call   80102be0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105547:	83 ec 08             	sub    $0x8,%esp
8010554a:	53                   	push   %ebx
8010554b:	ff 75 c0             	pushl  -0x40(%ebp)
8010554e:	e8 dd c9 ff ff       	call   80101f30 <nameiparent>
80105553:	83 c4 10             	add    $0x10,%esp
80105556:	85 c0                	test   %eax,%eax
80105558:	89 c6                	mov    %eax,%esi
8010555a:	0f 84 60 01 00 00    	je     801056c0 <sys_unlink+0x1a0>
  ilock(dp);
80105560:	83 ec 0c             	sub    $0xc,%esp
80105563:	50                   	push   %eax
80105564:	e8 47 c1 ff ff       	call   801016b0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105569:	58                   	pop    %eax
8010556a:	5a                   	pop    %edx
8010556b:	68 20 7f 10 80       	push   $0x80107f20
80105570:	53                   	push   %ebx
80105571:	e8 4a c6 ff ff       	call   80101bc0 <namecmp>
80105576:	83 c4 10             	add    $0x10,%esp
80105579:	85 c0                	test   %eax,%eax
8010557b:	0f 84 03 01 00 00    	je     80105684 <sys_unlink+0x164>
80105581:	83 ec 08             	sub    $0x8,%esp
80105584:	68 1f 7f 10 80       	push   $0x80107f1f
80105589:	53                   	push   %ebx
8010558a:	e8 31 c6 ff ff       	call   80101bc0 <namecmp>
8010558f:	83 c4 10             	add    $0x10,%esp
80105592:	85 c0                	test   %eax,%eax
80105594:	0f 84 ea 00 00 00    	je     80105684 <sys_unlink+0x164>
...
801055a3:	e8 38 c6 ff ff       	call   80101be0 <dirlookup>
801055a8:	83 c4 10             	add    $0x10,%esp
801055ab:	85 c0                	test   %eax,%eax
801055ad:	89 c3                	mov    %eax,%ebx
801055af:	0f 84 cf 00 00 00    	je     80105684 <sys_unlink+0x164>
  ilock(ip);
...
801055c6:	0f 8e 10 01 00 00    	jle    801056dc <sys_unlink+0x1bc>
  if(ip->type == T_DIR && !isdirempty(ip)){
801055cc:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801055d1:	74 6d                	je     80105640 <sys_unlink+0x120>
...
801055de:	e8 bd f5 ff ff       	call   80104ba0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801055e3:	8d 45 d8             	lea    -0x28(%ebp),%eax
801055e6:	6a 10                	push   $0x10
801055e8:	ff 75 c4             	pushl  -0x3c(%ebp)
801055eb:	50                   	push   %eax
801055ec:	56                   	push   %esi
801055ed:	e8 9e c4 ff ff       	call   80101a90 <writei>
801055f2:	83 c4 20             	add    $0x20,%esp
801055f5:	83 f8 10             	cmp    $0x10,%eax
801055f8:	0f 85 eb 00 00 00    	jne    801056e9 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
801055fe:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80105603:	0f 84 97 00 00 00    	je     801056a0 <sys_unlink+0x180>
  iunlockput(dp);
80105609:	83 ec 0c             	sub    $0xc,%esp
8010560c:	56                   	push   %esi
8010560d:	e8 2e c3 ff ff       	call   80101940 <iunlockput>
  ip->nlink--;
80105612:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105617:	89 1c 24             	mov    %ebx,(%esp)
8010561a:	e8 e1 bf ff ff       	call   80101600 <iupdate>
  iunlockput(ip);
8010561f:	89 1c 24             	mov    %ebx,(%esp)
80105622:	e8 19 c3 ff ff       	call   80101940 <iunlockput>
  end_op();
80105627:	e8 24 d6 ff ff       	call   80102c50 <end_op>
  return 0;
...
80105640:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
80105644:	76 8d                	jbe    801055d3 <sys_unlink+0xb3>
80105646:	bf 20 00 00 00       	mov    $0x20,%edi
8010564b:	eb 0f                	jmp    8010565c <sys_unlink+0x13c>
8010564d:	8d 76 00             	lea    0x0(%esi),%esi
80105650:	83 c7 10             	add    $0x10,%edi
80105653:	3b 7b 58             	cmp    0x58(%ebx),%edi
80105656:	0f 83 77 ff ff ff    	jae    801055d3 <sys_unlink+0xb3>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010565c:	8d 45 d8             	lea    -0x28(%ebp),%eax
8010565f:	6a 10                	push   $0x10
80105661:	57                   	push   %edi
80105662:	50                   	push   %eax
80105663:	53                   	push   %ebx
80105664:	e8 27 c3 ff ff       	call   80101990 <readi>
80105669:	83 c4 10             	add    $0x10,%esp
8010566c:	83 f8 10             	cmp    $0x10,%eax
8010566f:	75 5e                	jne    801056cf <sys_unlink+0x1af>
    if(de.inum != 0)
80105671:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80105676:	74 d8                	je     80105650 <sys_unlink+0x130>
    iunlockput(ip);
80105678:	83 ec 0c             	sub    $0xc,%esp
8010567b:	53                   	push   %ebx
8010567c:	e8 bf c2 ff ff       	call   80101940 <iunlockput>
    goto bad;
80105681:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
80105684:	83 ec 0c             	sub    $0xc,%esp
80105687:	56                   	push   %esi
80105688:	e8 b3 c2 ff ff       	call   80101940 <iunlockput>
  end_op();
8010568d:	e8 be d5 ff ff       	call   80102c50 <end_op>
  return -1;
80105692:	83 c4 10             	add    $0x10,%esp
80105695:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010569a:	eb 95                	jmp    80105631 <sys_unlink+0x111>
8010569c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink--;
801056a0:	66 83 6e 56 01       	subw   $0x1,0x56(%esi)
    iupdate(dp);
801056a5:	83 ec 0c             	sub    $0xc,%esp
801056a8:	56                   	push   %esi
801056a9:	e8 52 bf ff ff       	call   80101600 <iupdate>
801056ae:	83 c4 10             	add    $0x10,%esp
801056b1:	e9 53 ff ff ff       	jmp    80105609 <sys_unlink+0xe9>
    return -1;
801056b6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056bb:	e9 71 ff ff ff       	jmp    80105631 <sys_unlink+0x111>
    end_op();
801056c0:	e8 8b d5 ff ff       	call   80102c50 <end_op>
    return -1;
801056c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056ca:	e9 62 ff ff ff       	jmp    80105631 <sys_unlink+0x111>
      panic("isdirempty: readi");
801056cf:	83 ec 0c             	sub    $0xc,%esp
801056d2:	68 44 7f 10 80       	push   $0x80107f44
801056d7:	e8 b4 ac ff ff       	call   80100390 <panic>
    panic("unlink: nlink < 1");
801056dc:	83 ec 0c             	sub    $0xc,%esp
801056df:	68 32 7f 10 80       	push   $0x80107f32
801056e4:	e8 a7 ac ff ff       	call   80100390 <panic>
    panic("unlink: writei");
801056e9:	83 ec 0c             	sub    $0xc,%esp
801056ec:	68 56 7f 10 80       	push   $0x80107f56
...
8010570f:	e8 3c f8 ff ff       	call   80104f50 <argstr>
80105714:	83 c4 10             	add    $0x10,%esp
80105717:	85 c0                	test   %eax,%eax
80105719:	0f 88 1d 01 00 00    	js     8010583c <sys_open+0x13c>
8010571f:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105722:	83 ec 08             	sub    $0x8,%esp
80105725:	50                   	push   %eax
80105726:	6a 01                	push   $0x1
80105728:	e8 73 f7 ff ff       	call   80104ea0 <argint>
8010572d:	83 c4 10             	add    $0x10,%esp
80105730:	85 c0                	test   %eax,%eax
80105732:	0f 88 04 01 00 00    	js     8010583c <sys_open+0x13c>
    return -1;

  begin_op();
80105738:	e8 a3 d4 ff ff       	call   80102be0 <begin_op>

  if(omode & O_CREATE){
8010573d:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80105741:	0f 85 a9 00 00 00    	jne    801057f0 <sys_open+0xf0>
    if(ip == 0){
      end_op();
      return -1;
    }
...
8010574d:	e8 be c7 ff ff       	call   80101f10 <namei>
80105752:	83 c4 10             	add    $0x10,%esp
80105755:	85 c0                	test   %eax,%eax
80105757:	89 c6                	mov    %eax,%esi
80105759:	0f 84 b2 00 00 00    	je     80105811 <sys_open+0x111>
      end_op();
      return -1;
    }
    ilock(ip);
...
80105763:	e8 48 bf ff ff       	call   801016b0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105768:	83 c4 10             	add    $0x10,%esp
8010576b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105770:	0f 84 aa 00 00 00    	je     80105820 <sys_open+0x120>
      end_op();
      return -1;
    }
  }
...
80105776:	e8 35 b6 ff ff       	call   80100db0 <filealloc>
8010577b:	85 c0                	test   %eax,%eax
8010577d:	89 c7                	mov    %eax,%edi
8010577f:	0f 84 a6 00 00 00    	je     8010582b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105785:	e8 66 e0 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010578a:	31 db                	xor    %ebx,%ebx
8010578c:	eb 0e                	jmp    8010579c <sys_open+0x9c>
8010578e:	66 90                	xchg   %ax,%ax
80105790:	83 c3 01             	add    $0x1,%ebx
80105793:	83 fb 10             	cmp    $0x10,%ebx
80105796:	0f 84 ac 00 00 00    	je     80105848 <sys_open+0x148>
    if(curproc->ofile[fd] == 0){
8010579c:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
801057a0:	85 d2                	test   %edx,%edx
801057a2:	75 ec                	jne    80105790 <sys_open+0x90>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801057a4:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801057a7:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
801057ab:	56                   	push   %esi
801057ac:	e8 df bf ff ff       	call   80101790 <iunlock>
  end_op();
801057b1:	e8 9a d4 ff ff       	call   80102c50 <end_op>

  f->type = FD_INODE;
801057b6:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
...
801057bf:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
801057c2:	89 77 10             	mov    %esi,0x10(%edi)
  f->off = 0;
801057c5:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801057cc:	89 d0                	mov    %edx,%eax
801057ce:	f7 d0                	not    %eax
801057d0:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801057d3:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
801057d6:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801057d9:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
...
801057f3:	8b 45 e0             	mov    -0x20(%ebp),%eax
801057f6:	31 c9                	xor    %ecx,%ecx
801057f8:	6a 00                	push   $0x0
801057fa:	ba 02 00 00 00       	mov    $0x2,%edx
801057ff:	e8 ec f7 ff ff       	call   80104ff0 <create>
    if(ip == 0){
...
80105809:	89 c6                	mov    %eax,%esi
    if(ip == 0){
8010580b:	0f 85 65 ff ff ff    	jne    80105776 <sys_open+0x76>
      end_op();
80105811:	e8 3a d4 ff ff       	call   80102c50 <end_op>
      return -1;
80105816:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010581b:	eb c0                	jmp    801057dd <sys_open+0xdd>
8010581d:	8d 76 00             	lea    0x0(%esi),%esi
    if(ip->type == T_DIR && omode != O_RDONLY){
80105820:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80105823:	85 c9                	test   %ecx,%ecx
80105825:	0f 84 4b ff ff ff    	je     80105776 <sys_open+0x76>
    iunlockput(ip);
8010582b:	83 ec 0c             	sub    $0xc,%esp
8010582e:	56                   	push   %esi
8010582f:	e8 0c c1 ff ff       	call   80101940 <iunlockput>
    end_op();
80105834:	e8 17 d4 ff ff       	call   80102c50 <end_op>
    return -1;
80105839:	83 c4 10             	add    $0x10,%esp
8010583c:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105841:	eb 9a                	jmp    801057dd <sys_open+0xdd>
80105843:	90                   	nop
80105844:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      fileclose(f);
80105848:	83 ec 0c             	sub    $0xc,%esp
8010584b:	57                   	push   %edi
8010584c:	e8 1f b6 ff ff       	call   80100e70 <fileclose>
80105851:	83 c4 10             	add    $0x10,%esp
80105854:	eb d5                	jmp    8010582b <sys_open+0x12b>
...
80105863:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105866:	e8 75 d3 ff ff       	call   80102be0 <begin_op>
...
8010588a:	ba 01 00 00 00       	mov    $0x1,%edx
8010588f:	e8 5c f7 ff ff       	call   80104ff0 <create>
...
8010589f:	e8 9c c0 ff ff       	call   80101940 <iunlockput>
  end_op();
801058a4:	e8 a7 d3 ff ff       	call   80102c50 <end_op>
  return 0;
...
801058c3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801058c6:	e8 15 d3 ff ff       	call   80102be0 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801058e9:	e8 b2 f5 ff ff       	call   80104ea0 <argint>
  if((argstr(0, &path)) < 0 ||
...
801058fe:	e8 9d f5 ff ff       	call   80104ea0 <argint>
     argint(1, &major) < 0 ||
...
8010591e:	e8 cd f6 ff ff       	call   80104ff0 <create>
...
8010592e:	e8 0d c0 ff ff       	call   80101940 <iunlockput>
  end_op();
80105933:	e8 18 d3 ff ff       	call   80102c50 <end_op>
  return 0;
...
8010593f:	90                   	nop
    end_op();
80105940:	e8 0b d3 ff ff       	call   80102c50 <end_op>
    return -1;
...
8010595d:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
8010595f:	e8 7c d2 ff ff       	call   80102be0 <begin_op>
...
8010597f:	e8 8c c5 ff ff       	call   80101f10 <namei>
80105984:	83 c4 10             	add    $0x10,%esp
80105987:	85 c0                	test   %eax,%eax
80105989:	89 c3                	mov    %eax,%ebx
...
80105991:	e8 1a bd ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
...
801059a4:	e8 e7 bd ff ff       	call   80101790 <iunlock>
  iput(curproc->cwd);
801059a9:	58                   	pop    %eax
801059aa:	ff 76 6c             	pushl  0x6c(%esi)
801059ad:	e8 2e be ff ff       	call   801017e0 <iput>
  end_op();
801059b2:	e8 99 d2 ff ff       	call   80102c50 <end_op>
  curproc->cwd = ip;
...
801059d4:	e8 67 bf ff ff       	call   80101940 <iunlockput>
    end_op();
801059d9:	e8 72 d2 ff ff       	call   80102c50 <end_op>
    return -1;
...
801059e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    end_op();
801059f0:	e8 5b d2 ff ff       	call   80102c50 <end_op>
    return -1;
...
80105a06:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
...
80105a25:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80105a2b:	83 ec 08             	sub    $0x8,%esp
80105a2e:	50                   	push   %eax
80105a2f:	6a 01                	push   $0x1
80105a31:	e8 6a f4 ff ff       	call   80104ea0 <argint>
...
80105a3d:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
...
80105a4f:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105a55:	50                   	push   %eax
80105a56:	e8 45 f1 ff ff       	call   80104ba0 <memset>
80105a5b:	83 c4 10             	add    $0x10,%esp
80105a5e:	eb 2c                	jmp    80105a8c <sys_exec+0x8c>
    if(i >= NELEM(argv))
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
      return -1;
    if(uarg == 0){
80105a60:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
80105a66:	85 c0                	test   %eax,%eax
80105a68:	74 56                	je     80105ac0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80105a6a:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
80105a70:	83 ec 08             	sub    $0x8,%esp
80105a73:	8d 14 31             	lea    (%ecx,%esi,1),%edx
80105a76:	52                   	push   %edx
80105a77:	50                   	push   %eax
80105a78:	e8 b3 f3 ff ff       	call   80104e30 <fetchstr>
80105a7d:	83 c4 10             	add    $0x10,%esp
80105a80:	85 c0                	test   %eax,%eax
80105a82:	78 28                	js     80105aac <sys_exec+0xac>
  for(i=0;; i++){
80105a84:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80105a87:	83 fb 20             	cmp    $0x20,%ebx
80105a8a:	74 20                	je     80105aac <sys_exec+0xac>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80105a8c:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80105a92:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
80105a99:	83 ec 08             	sub    $0x8,%esp
80105a9c:	57                   	push   %edi
80105a9d:	01 f0                	add    %esi,%eax
80105a9f:	50                   	push   %eax
80105aa0:	e8 4b f3 ff ff       	call   80104df0 <fetchint>
80105aa5:	83 c4 10             	add    $0x10,%esp
80105aa8:	85 c0                	test   %eax,%eax
80105aaa:	79 b4                	jns    80105a60 <sys_exec+0x60>
      return -1;
  }
...
80105ad5:	ff b5 5c ff ff ff    	pushl  -0xa4(%ebp)
80105adb:	e8 30 af ff ff       	call   80100a10 <exec>
...
80105af6:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
...
80105b57:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105b5a:	e8 91 dc ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80105b5f:	31 d2                	xor    %edx,%edx
80105b61:	eb 0d                	jmp    80105b70 <sys_pipe+0x80>
80105b63:	90                   	nop
80105b64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105b68:	83 c2 01             	add    $0x1,%edx
80105b6b:	83 fa 10             	cmp    $0x10,%edx
80105b6e:	74 28                	je     80105b98 <sys_pipe+0xa8>
    if(curproc->ofile[fd] == 0){
80105b70:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
80105b74:	85 c9                	test   %ecx,%ecx
80105b76:	75 f0                	jne    80105b68 <sys_pipe+0x78>
      curproc->ofile[fd] = f;
80105b78:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
80105b7c:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105b7f:	89 18                	mov    %ebx,(%eax)
  fd[1] = fd1;
80105b81:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105b84:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
...
80105b91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105b98:	e8 53 dc ff ff       	call   801037f0 <myproc>
80105b9d:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
80105ba4:	00 
80105ba5:	8d 76 00             	lea    0x0(%esi),%esi
    fileclose(rf);
80105ba8:	83 ec 0c             	sub    $0xc,%esp
80105bab:	ff 75 e0             	pushl  -0x20(%ebp)
80105bae:	e8 bd b2 ff ff       	call   80100e70 <fileclose>
    fileclose(wf);
80105bb3:	58                   	pop    %eax
80105bb4:	ff 75 e4             	pushl  -0x1c(%ebp)
80105bb7:	e8 b4 b2 ff ff       	call   80100e70 <fileclose>
    return -1;
80105bbc:	83 c4 10             	add    $0x10,%esp
80105bbf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bc4:	eb c3                	jmp    80105b89 <sys_pipe+0x99>
...
80105bd3:	5d                   	pop    %ebp
  return fork();
80105bd4:	e9 37 df ff ff       	jmp    80103b10 <fork>
...
80105be3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105be6:	e8 75 e2 ff ff       	call   80103e60 <exit>
...
80105bf3:	5d                   	pop    %ebp
  return wait();
80105bf4:	e9 b7 e4 ff ff       	jmp    801040b0 <wait>
...
80105c0c:	e8 8f f2 ff ff       	call   80104ea0 <argint>
80105c11:	83 c4 10             	add    $0x10,%esp
80105c14:	85 c0                	test   %eax,%eax
80105c16:	78 28                	js     80105c40 <sys_kill+0x40>
    return -1;
...
80105c53:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105c56:	e8 95 db ff ff       	call   801037f0 <myproc>
...
80105c6d:	e8 2e f2 ff ff       	call   80104ea0 <argint>
...
80105c86:	e8 05 de ff ff       	call   80103a90 <growproc>
...
80105cbd:	e8 de f1 ff ff       	call   80104ea0 <argint>
...
80105cd0:	68 60 a1 11 80       	push   $0x8011a160
80105cd5:	e8 b6 ed ff ff       	call   80104a90 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105cda:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105cdd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105ce0:	8b 1d a0 a9 11 80    	mov    0x8011a9a0,%ebx
  while(ticks - ticks0 < n){
...
80105cf3:	68 60 a1 11 80       	push   $0x8011a160
80105cf8:	68 a0 a9 11 80       	push   $0x8011a9a0
80105cfd:	e8 de e2 ff ff       	call   80103fe0 <sleep>
  while(ticks - ticks0 < n){
80105d02:	a1 a0 a9 11 80       	mov    0x8011a9a0,%eax
...
80105d0f:	73 2f                	jae    80105d40 <sys_sleep+0x90>
    if(myproc()->killed){
80105d11:	e8 da da ff ff       	call   801037f0 <myproc>
...
80105d20:	68 60 a1 11 80       	push   $0x8011a160
80105d25:	e8 26 ee ff ff       	call   80104b50 <release>
      return -1;
...
80105d43:	68 60 a1 11 80       	push   $0x8011a160
80105d48:	e8 03 ee ff ff       	call   80104b50 <release>
  return 0;
...
80105d64:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105d67:	68 60 a1 11 80       	push   $0x8011a160
80105d6c:	e8 1f ed ff ff       	call   80104a90 <acquire>
  xticks = ticks;
80105d71:	8b 1d a0 a9 11 80    	mov    0x8011a9a0,%ebx
  release(&tickslock);
80105d77:	c7 04 24 60 a1 11 80 	movl   $0x8011a160,(%esp)
80105d7e:	e8 cd ed ff ff       	call   80104b50 <release>
  return xticks;
}
...
80105e2f:	ff 75 ec             	pushl  -0x14(%ebp)
80105e32:	e8 99 e6 ff ff       	call   801044d0 <sigaction>
...
80105e53:	83 ec 08             	sub    $0x8,%esp
  sigret();
80105e56:	e8 65 e7 ff ff       	call   801045c0 <sigret>
  return 0;
...
trapret:
  pushl %esp
80105e77:	54                   	push   %esp
  call handle_signals
80105e78:	e8 d3 e7 ff ff       	call   80104650 <handle_signals>
  addl $4, %esp
80105e7d:	83 c4 04             	add    $0x4,%esp
  popal
80105e80:	61                   	popa   
  popl %gs
80105e81:	0f a9                	pop    %gs
  popl %fs
80105e83:	0f a1                	pop    %fs
  popl %es
80105e85:	07                   	pop    %es
  popl %ds
80105e86:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105e87:	83 c4 08             	add    $0x8,%esp
  iret
80105e8a:	cf                   	iret   
80105e8b:	66 90                	xchg   %ax,%ax
80105e8d:	66 90                	xchg   %ax,%ax
80105e8f:	90                   	nop
...
80105ea7:	c7 04 c5 a2 a1 11 80 	movl   $0x8e000008,-0x7fee5e5e(,%eax,8)
80105eae:	08 00 00 8e 
80105eb2:	66 89 14 c5 a0 a1 11 	mov    %dx,-0x7fee5e60(,%eax,8)
80105eb9:	80 
80105eba:	c1 ea 10             	shr    $0x10,%edx
80105ebd:	66 89 14 c5 a6 a1 11 	mov    %dx,-0x7fee5e5a(,%eax,8)
80105ec4:	80 
  for(i = 0; i < 256; i++)
...
80105ed4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ed7:	c7 05 a2 a3 11 80 08 	movl   $0xef000008,0x8011a3a2
80105ede:	00 00 ef 
  initlock(&tickslock, "time");
80105ee1:	68 65 7f 10 80       	push   $0x80107f65
80105ee6:	68 60 a1 11 80       	push   $0x8011a160
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105eeb:	66 a3 a0 a3 11 80    	mov    %ax,0x8011a3a0
80105ef1:	c1 e8 10             	shr    $0x10,%eax
80105ef4:	66 a3 a6 a3 11 80    	mov    %ax,0x8011a3a6
  initlock(&tickslock, "time");
80105efa:	e8 51 ea ff ff       	call   80104950 <initlock>
}
...
80105f1b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105f1f:	b8 a0 a1 11 80       	mov    $0x8011a1a0,%eax
...
80105f60:	ff 24 85 0c 80 10 80 	jmp    *-0x7fef7ff4(,%eax,4)
...
80105f70:	e8 7b d8 ff ff       	call   801037f0 <myproc>
...
80105f90:	e8 3b d8 ff ff       	call   801037d0 <cpuid>
...
80105fa1:	e8 4a d8 ff ff       	call   801037f0 <myproc>
80105fa6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105fa9:	e8 42 d8 ff ff       	call   801037f0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105fde:	e8 0d d8 ff ff       	call   801037f0 <myproc>
80105fe3:	85 c0                	test   %eax,%eax
80105fe5:	74 1d                	je     80106004 <trap+0xc4>
80105fe7:	e8 04 d8 ff ff       	call   801037f0 <myproc>
...
80106004:	e8 e7 d7 ff ff       	call   801037f0 <myproc>
80106009:	85 c0                	test   %eax,%eax
8010600b:	74 0d                	je     8010601a <trap+0xda>
8010600d:	e8 de d7 ff ff       	call   801037f0 <myproc>
80106012:	8b 40 0c             	mov    0xc(%eax),%eax
80106015:	83 f8 04             	cmp    $0x4,%eax
80106018:	74 66                	je     80106080 <trap+0x140>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010601a:	e8 d1 d7 ff ff       	call   801037f0 <myproc>
8010601f:	85 c0                	test   %eax,%eax
80106021:	74 19                	je     8010603c <trap+0xfc>
80106023:	e8 c8 d7 ff ff       	call   801037f0 <myproc>
80106028:	8b 40 24             	mov    0x24(%eax),%eax
8010602b:	85 c0                	test   %eax,%eax
8010602d:	74 0d                	je     8010603c <trap+0xfc>
8010602f:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80106033:	83 e0 03             	and    $0x3,%eax
80106036:	66 83 f8 03          	cmp    $0x3,%ax
8010603a:	74 35                	je     80106071 <trap+0x131>
    exit();
}
...
80106044:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80106048:	e8 a3 d7 ff ff       	call   801037f0 <myproc>
8010604d:	8b 58 24             	mov    0x24(%eax),%ebx
80106050:	85 db                	test   %ebx,%ebx
80106052:	0f 85 e8 00 00 00    	jne    80106140 <trap+0x200>
    myproc()->tf = tf;
80106058:	e8 93 d7 ff ff       	call   801037f0 <myproc>
8010605d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80106060:	e8 2b ef ff ff       	call   80104f90 <syscall>
    if(myproc()->killed)
80106065:	e8 86 d7 ff ff       	call   801037f0 <myproc>
8010606a:	8b 48 24             	mov    0x24(%eax),%ecx
8010606d:	85 c9                	test   %ecx,%ecx
8010606f:	74 cb                	je     8010603c <trap+0xfc>
}
...
80106077:	5d                   	pop    %ebp
      exit();
80106078:	e9 e3 dd ff ff       	jmp    80103e60 <exit>
8010607d:	8d 76 00             	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80106080:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
80106084:	75 94                	jne    8010601a <trap+0xda>
    yield();
80106086:	e8 f5 de ff ff       	call   80103f80 <yield>
8010608b:	eb 8d                	jmp    8010601a <trap+0xda>
8010608d:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80106090:	e8 3b d7 ff ff       	call   801037d0 <cpuid>
80106095:	85 c0                	test   %eax,%eax
80106097:	0f 84 c3 00 00 00    	je     80106160 <trap+0x220>
    lapiceoi();
8010609d:	e8 ee c6 ff ff       	call   80102790 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801060a2:	e8 49 d7 ff ff       	call   801037f0 <myproc>
...
801060b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801060b8:	e8 93 c5 ff ff       	call   80102650 <kbdintr>
    lapiceoi();
801060bd:	e8 ce c6 ff ff       	call   80102790 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
801060d8:	e8 53 02 00 00       	call   80106330 <uartintr>
    lapiceoi();
801060dd:	e8 ae c6 ff ff       	call   80102790 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801060e2:	e8 09 d7 ff ff       	call   801037f0 <myproc>
...
801060ff:	e8 cc d6 ff ff       	call   801037d0 <cpuid>
80106104:	56                   	push   %esi
80106105:	53                   	push   %ebx
80106106:	50                   	push   %eax
80106107:	68 70 7f 10 80       	push   $0x80107f70
8010610c:	e8 4f a5 ff ff       	call   80100660 <cprintf>
    lapiceoi();
80106111:	e8 7a c6 ff ff       	call   80102790 <lapiceoi>
    break;
80106116:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106119:	e8 d2 d6 ff ff       	call   801037f0 <myproc>
...
8010612c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80106130:	e8 7b bf ff ff       	call   801020b0 <ideintr>
80106135:	e9 63 ff ff ff       	jmp    8010609d <trap+0x15d>
8010613a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80106140:	e8 1b dd ff ff       	call   80103e60 <exit>
80106145:	e9 0e ff ff ff       	jmp    80106058 <trap+0x118>
8010614a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80106150:	e8 0b dd ff ff       	call   80103e60 <exit>
80106155:	e9 aa fe ff ff       	jmp    80106004 <trap+0xc4>
8010615a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80106160:	83 ec 0c             	sub    $0xc,%esp
80106163:	68 60 a1 11 80       	push   $0x8011a160
80106168:	e8 23 e9 ff ff       	call   80104a90 <acquire>
      wakeup(&ticks);
8010616d:	c7 04 24 a0 a9 11 80 	movl   $0x8011a9a0,(%esp)
      ticks++;
80106174:	83 05 a0 a9 11 80 01 	addl   $0x1,0x8011a9a0
      wakeup(&ticks);
8010617b:	e8 00 e1 ff ff       	call   80104280 <wakeup>
      release(&tickslock);
80106180:	c7 04 24 60 a1 11 80 	movl   $0x8011a160,(%esp)
80106187:	e8 c4 e9 ff ff       	call   80104b50 <release>
8010618c:	83 c4 10             	add    $0x10,%esp
8010618f:	e9 09 ff ff ff       	jmp    8010609d <trap+0x15d>
80106194:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106197:	e8 34 d6 ff ff       	call   801037d0 <cpuid>
...
801061a5:	68 94 7f 10 80       	push   $0x80107f94
801061aa:	e8 b1 a4 ff ff       	call   80100660 <cprintf>
      panic("trap");
801061af:	83 c4 14             	add    $0x14,%esp
801061b2:	68 6a 7f 10 80       	push   $0x80107f6a
...
80106215:	e8 96 c5 ff ff       	call   801027b0 <microdelay>
...
801062ac:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801062af:	bb 8c 80 10 80       	mov    $0x8010808c,%ebx
  ioapicenable(IRQ_COM1, 0);
801062b4:	6a 00                	push   $0x0
801062b6:	6a 04                	push   $0x4
801062b8:	e8 53 c0 ff ff       	call   80102310 <ioapicenable>
...
80106e04:	e8 f7 b6 ff ff       	call   80102500 <kalloc>
...
80106e1a:	e8 81 dd ff ff       	call   80104ba0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106ebd:	68 94 80 10 80       	push   $0x80108094
...
80106f14:	e8 37 b4 ff ff       	call   80102350 <kfree>
      *pte = 0;
...
80106f73:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106f76:	e8 55 c8 ff ff       	call   801037d0 <cpuid>
...
80107000:	a1 a4 a9 11 80       	mov    0x8011a9a4,%eax
{
...
80107044:	0f 84 c2 00 00 00    	je     8010710c <switchuvm+0xec>
  pushcli();
8010704a:	e8 71 d9 ff ff       	call   801049c0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010704f:	e8 fc c6 ff ff       	call   80103750 <mycpu>
80107054:	89 c6                	mov    %eax,%esi
80107056:	e8 f5 c6 ff ff       	call   80103750 <mycpu>
8010705b:	89 c7                	mov    %eax,%edi
8010705d:	e8 ee c6 ff ff       	call   80103750 <mycpu>
80107062:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107065:	83 c7 08             	add    $0x8,%edi
80107068:	e8 e3 c6 ff ff       	call   80103750 <mycpu>
...
8010714b:	77 49                	ja     80107196 <inituvm+0x66>
  mem = kalloc();
8010714d:	e8 ae b3 ff ff       	call   80102500 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010715f:	e8 3c da ff ff       	call   80104ba0 <memset>
...
80107190:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107191:	e9 ba da ff ff       	jmp    80104c50 <memmove>
    panic("inituvm: more than a page");
80107196:	83 ec 0c             	sub    $0xc,%esp
80107199:	68 d9 80 10 80       	push   $0x801080d9
...
80107221:	e8 6a a7 ff ff       	call   80101990 <readi>
...
801072bb:	e8 e0 d8 ff ff       	call   80104ba0 <memset>
...
801072e9:	0f 86 81 00 00 00    	jbe    80107370 <allocuvm+0x100>
    mem = kalloc();
801072ef:	e8 0c b2 ff ff       	call   80102500 <kalloc>
    if(mem == 0){
...
801072fd:	68 11 81 10 80       	push   $0x80108111
...
80107333:	68 29 81 10 80       	push   $0x80108129
...
8010735b:	e8 f0 af ff ff       	call   80102350 <kfree>
      return 0;
...
8010741e:	e8 2d af ff ff       	call   80102350 <kfree>
...
80107433:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107434:	e9 17 af ff ff       	jmp    80102350 <kfree>
    panic("freevm: no pgdir");
80107439:	83 ec 0c             	sub    $0xc,%esp
8010743c:	68 45 81 10 80       	push   $0x80108145
...
80107455:	e8 a6 b0 ff ff       	call   80102500 <kalloc>
...
80107470:	e8 2b d7 ff ff       	call   80104ba0 <memset>
...
801074db:	a3 a4 a9 11 80       	mov    %eax,0x8011a9a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010750f:	68 56 81 10 80       	push   $0x80108156
...
80107560:	e8 eb d6 ff ff       	call   80104c50 <memmove>
...
801075b5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801075b8:	e8 43 af ff ff       	call   80102500 <kalloc>
...
8010768f:	e8 bc d5 ff ff       	call   80104c50 <memmove>
    len -= n;
    buf += n;
